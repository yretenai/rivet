...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED HoverbootJumpData : rivet::structures::rivet_ddl_base {
		constexpr const static std::string_view type_name = "HoverbootJumpData";
		constexpr const static rivet::rivet_type_id type_id = 0xb930036d;
		...
		explicit HoverbootJumpData() = default;
		explicit HoverbootJumpData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<HoverbootJumpData>;
	};
} // namespace rivet::ddl::generated
