...
[DDLRegistration(0x10205caau)]
public class Cinematic2AudioGameSyncActionDef : DDLObjectType, IDDLObjectType<Cinematic2AudioGameSyncActionDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x10205caau);

	public Cinematic2AudioGameSyncActionDef(DDLObject ddl) : base(ddl) {
	...
	public static Cinematic2AudioGameSyncActionDef Create(DDLObject ddl) => new(ddl);
}
