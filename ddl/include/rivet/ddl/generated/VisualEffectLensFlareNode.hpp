...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED VisualEffectLensFlareNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectLensFlareNode";
		constexpr static rivet::rivet_type_id type_id = 0xb08a873c;
		...
		explicit VisualEffectLensFlareNode() = default;
		explicit VisualEffectLensFlareNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::VisualEffectLensFlare> OutputPort_Output {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectLensFlareNode>;
	};
} // namespace rivet::ddl::generated
