...
namespace rivet::ddl::generated {
	ShrubbingPref::ShrubbingPref([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		Algorithm = serialized->get_enum<rivet::ddl::generated::x6ad2490c>(Algorithm_type_id, rivet::ddl::generated::x6ad2490c_values);
		Rotation = serialized->get_float(Rotation_type_id);
		RotationRandom = serialized->get_float(RotationRandom_type_id);
		NormalTilt = serialized->get_float(NormalTilt_type_id);
		Scale = serialized->get_float(Scale_type_id);
		ScaleRandom = serialized->get_float(ScaleRandom_type_id);
		WheelControl = serialized->get_enum<rivet::ddl::generated::xc6714fdc>(WheelControl_type_id, rivet::ddl::generated::xc6714fdc_values);
		...
		Footprint = serialized->get_float(Footprint_type_id); 
	}
