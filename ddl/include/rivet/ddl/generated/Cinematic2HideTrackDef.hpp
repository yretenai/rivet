...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2HideTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2HideTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x49b8dc37;
		...
		explicit Cinematic2HideTrackDef() = default;
		explicit Cinematic2HideTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2HideTrackDef>;
	};
} // namespace rivet::ddl::generated
