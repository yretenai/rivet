...
namespace rivet::ddl::generated {
	AimAssistCentering::AimAssistCentering([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		MinBoxValue = serialized->get_float(MinBoxValue_type_id);
		MaxBoxValue = serialized->get_float(MaxBoxValue_type_id); 
	}

	auto
	AimAssistCentering::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}
