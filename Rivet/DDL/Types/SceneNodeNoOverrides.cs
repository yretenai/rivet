...
public class SceneNodeNoOverrides : DDLObjectType, IDDLObjectType<SceneNodeNoOverrides> {
	...
	[DDLRegistration(0x7aaa4395u, "Transform")]
	...
	[DDLRegistration(0x7aaa4395u, description: "User settable sorting key")]
	public float SortValue { get; set; } = 0.00f;

	[DDLRegistration(0x7aaa4395u, "Type")]
	public AssetExtensions AssetType { get; set; } = AssetExtensions.Actor;

	[DDLRegistration(0x7aaa4395u, "Asset Path")]
	...
	[DDLRegistration(0x7aaa4395u, "Asset Overrides")]
	public string? AssetOverrides { get; set; } = default;

	[DDLRegistration(0x7aaa4395u, "Actor Overrides")]
