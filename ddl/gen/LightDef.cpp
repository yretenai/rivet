...
namespace rivet::ddl::generated {
	LightDef::LightDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		UseColorTemperature = serialized->get_bool(UseColorTemperature_type_id, false);
		Color = serialized->unwrap_into<rivet::ddl::generated::DDLVector3>(Color_type_id);
		ColorTemperature = serialized->get_float(ColorTemperature_type_id, 6500.000000f);
		Intensity = serialized->get_float(Intensity_type_id, 10.000000f);
		AttenuationRadius = serialized->get_float(AttenuationRadius_type_id, 0.000000f);
		VolumetricFogIntensity = serialized->get_float(VolumetricFogIntensity_type_id, 0.000000f);
		Saturation = serialized->get_float(Saturation_type_id, 1.000000f);
		...
		ModulateLocalLights = serialized->get_bool(ModulateLocalLights_type_id, true);
		...
		ShadowCastType = serialized->get_enum<rivet::ddl::generated::ShadowCastType>(ShadowCastType_type_id, rivet::ddl::generated::ShadowCastType_values, rivet::ddl::generated::ShadowCastType::Cache_Static_Models);
		...
		SpecType = serialized->get_enum<rivet::ddl::generated::SpecType>(SpecType_type_id, rivet::ddl::generated::SpecType_values, rivet::ddl::generated::SpecType::Both);
		BulbRadius = serialized->get_float(BulbRadius_type_id, 0.000000f);
		BulbLength = serialized->get_float(BulbLength_type_id, 0.000000f);
		BulbPushForward = serialized->get_float(BulbPushForward_type_id, 0.000000f);
		...
		CutoffRadius = serialized->get_float(CutoffRadius_type_id, 0.000000f);
		CutOnDist = serialized->get_float(CutOnDist_type_id, 0.000000f);
		ShadowCutOnDist = serialized->get_float(ShadowCutOnDist_type_id, 0.000000f);
		FalloffDistX = serialized->get_float(FalloffDistX_type_id, 1.000000f);
		FalloffDistPosX = serialized->get_float(FalloffDistPosX_type_id, 1.000000f);
		FalloffDistY = serialized->get_float(FalloffDistY_type_id, 1.000000f);
		FalloffDistPosY = serialized->get_float(FalloffDistPosY_type_id, 1.000000f);
		FalloffDistZ = serialized->get_float(FalloffDistZ_type_id, 1.000000f);
		FalloffDistPosZ = serialized->get_float(FalloffDistPosZ_type_id, 1.000000f);
		FadeOutDist = serialized->get_float(FadeOutDist_type_id, 70.000000f);
		NearFadeClipDist = serialized->get_float(NearFadeClipDist_type_id, 0.000000f);
		NearFadeStartDist = serialized->get_float(NearFadeStartDist_type_id, 0.000000f);
		ShadowFadeOutDist = serialized->get_float(ShadowFadeOutDist_type_id, 0.000000f);
		SpecFadeOutDist = serialized->get_float(SpecFadeOutDist_type_id, 0.000000f);
