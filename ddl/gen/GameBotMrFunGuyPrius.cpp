...
namespace rivet::ddl::generated {
	GameBotMrFunGuyPrius::GameBotMrFunGuyPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): GameBotMeleeBasePrius(serialized) {
		...
		GasLifetime = serialized->get_float(GasLifetime_type_id);
		HoverHeight = serialized->get_float(HoverHeight_type_id);
		ModelScale = serialized->get_float(ModelScale_type_id);
		GasTargetingRadius = serialized->get_float(GasTargetingRadius_type_id); 
	}
