...
namespace rivet::ddl::generated {
	SharedSettings::SharedSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		StreamingVideoMaxStreams = serialized->get_uint8(StreamingVideoMaxStreams_type_id, 32u);
		StreamingVideoGpuHeapSize = serialized->get_uint64(StreamingVideoGpuHeapSize_type_id, 8388608ull);
		StreamingVideoMainHeapSize = serialized->get_uint64(StreamingVideoMainHeapSize_type_id, 20971520ull);
		...
		MaxCoverObjects = serialized->get_int32(MaxCoverObjects_type_id, 2048u);
		TargetSystem = serialized->unwrap_into<rivet::ddl::generated::TargetSystemSettings>(TargetSystem_type_id);
		GameTcpPort = serialized->get_uint16(GameTcpPort_type_id, 0u);
		GameUdpPort = serialized->get_uint16(GameUdpPort_type_id, 0u);
		...
		ActorSaveUidMax = serialized->get_uint32(ActorSaveUidMax_type_id, 3096u);
		ActorSaveLocalUidMax = serialized->get_uint8(ActorSaveLocalUidMax_type_id, 64u);
		...
		KickableDrawnTurnOnDistance = serialized->get_float(KickableDrawnTurnOnDistance_type_id, 60.000000f);
		KickableDrawnTurnOffDistance = serialized->get_float(KickableDrawnTurnOffDistance_type_id, 70.000000f);
		KickableNotDrawnTurnOnDistance = serialized->get_float(KickableNotDrawnTurnOnDistance_type_id, 30.000000f);
		KickableNotDrawnTurnOffDistance = serialized->get_float(KickableNotDrawnTurnOffDistance_type_id, 35.000000f);
		...
		POIScreenMarginPercentWidth = serialized->get_float(POIScreenMarginPercentWidth_type_id, 0.000000f);
		POIScreenMarginPercentHeight = serialized->get_float(POIScreenMarginPercentHeight_type_id, 0.000000f);
		FirepointGunHoldOffsetHigh = serialized->get_float(FirepointGunHoldOffsetHigh_type_id, 1.400000f);
		FirepointGunHoldOffsetLow = serialized->get_float(FirepointGunHoldOffsetLow_type_id, 0.750000f);
		FirepointMaxGathered = serialized->get_int32(FirepointMaxGathered_type_id, 512u);
		FirepointMaxEval = serialized->get_int32(FirepointMaxEval_type_id, 512u);
		DialogSetSystemMaxSets = serialized->get_uint32(DialogSetSystemMaxSets_type_id, 1024u);
		DialogSetSystemSaveSize = serialized->get_uint32(DialogSetSystemSaveSize_type_id, 32768u);
		...
		GameplayBuiltVolumeMaxBuiltZones = serialized->get_uint32(GameplayBuiltVolumeMaxBuiltZones_type_id, 96u);
		GameplayBuiltVolumeMaxBuilttVolumes = serialized->get_uint32(GameplayBuiltVolumeMaxBuilttVolumes_type_id, 8192u);
		...
		OpenWorldNumColumns = serialized->get_uint32(OpenWorldNumColumns_type_id, 26u);
		OpenWorldNumRows = serialized->get_uint32(OpenWorldNumRows_type_id, 48u);
		OpenWorldCellWidth = serialized->get_float(OpenWorldCellWidth_type_id, 128.000000f);
		OpenWorldCellLength = serialized->get_float(OpenWorldCellLength_type_id, 128.000000f);
		OpenWorldMaxCharsPerCellOnMap = serialized->get_uint32(OpenWorldMaxCharsPerCellOnMap_type_id, 4u);
		OpenWorldColumnLetterOffset = serialized->get_uint32(OpenWorldColumnLetterOffset_type_id, 0u);
		OpenWorldRowNumberOffset = serialized->get_uint32(OpenWorldRowNumberOffset_type_id, 0u);
		OpenWorldGridMapWidth = serialized->get_uint32(OpenWorldGridMapWidth_type_id, 900u);
		OpenWorldGridMapHeight = serialized->get_uint32(OpenWorldGridMapHeight_type_id, 950u);
		PerfTestMaxNumRecordings = serialized->get_uint32(PerfTestMaxNumRecordings_type_id, 2048u);
		...
		PerfTestMissionTestSkipCineTime = serialized->get_float(PerfTestMissionTestSkipCineTime_type_id, 1.000000f);
		PerfRTHeroDistanceMovingFastSpeed = serialized->get_float(PerfRTHeroDistanceMovingFastSpeed_type_id, 15.000000f);
		PerfRTHeroDistanceMovingFastCount = serialized->get_uint32(PerfRTHeroDistanceMovingFastCount_type_id, 20u);
		PerfRTHeroDistanceMovingSlowCount = serialized->get_uint32(PerfRTHeroDistanceMovingSlowCount_type_id, 220u);
		PerfRTHeroDistanceFirstRingRadius = serialized->get_float(PerfRTHeroDistanceFirstRingRadius_type_id, 15.000000f);
		PerfRTHeroDistanceSecondRingRadius = serialized->get_float(PerfRTHeroDistanceSecondRingRadius_type_id, 40.000000f); 
	}
