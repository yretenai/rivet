...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED SceneNodeNoOverrides : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "SceneNodeNoOverrides";
		constexpr static rivet::rivet_type_id type_id = 0x7aaa4395;
		...
		explicit SceneNodeNoOverrides() = default;
		explicit SceneNodeNoOverrides([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<SceneNodeNoOverrides>;
	};
} // namespace rivet::ddl::generated
