...
namespace rivet::ddl::generated {
	ShootProjectileData::ShootProjectileData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		ShootFlags = serialized->get_bitset<rivet::ddl::generated::x768b595c>(ShootFlags_type_id, rivet::ddl::generated::x768b595c_values);
		...
		ChargeTimeMin = serialized->get_float(ChargeTimeMin_type_id);
		...
		UseOverrideBurst = serialized->get_bool(UseOverrideBurst_type_id);
		...
		CleanupAimModsOnBurstComplete = serialized->get_bool(CleanupAimModsOnBurstComplete_type_id); 
	}

	auto
	ShootProjectileData::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}
