...
#include <rivet/ddl/generated/TerrainSystem03EditingTerrain.hpp>
...
namespace rivet::ddl::generated {
	...
	[[nodiscard]] auto
	TerrainSystem03EditingTerrain::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	TerrainSystem03EditingTerrain::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TerrainSystem03EditingTerrain> {
		if (incoming_type_id == TerrainSystem03EditingTerrain::type_id) {
			return std::make_shared<TerrainSystem03EditingTerrain>(serialized);
		}
