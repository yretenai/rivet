...
namespace rivet::ddl::generated {
	VanityPerkWrenchDamage::VanityPerkWrenchDamage([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): VanityPerkBase(serialized) {
		WrenchDamageMultSet = serialized->get_float(WrenchDamageMultSet_type_id);
		WrenchDamageMultPiece = serialized->get_float(WrenchDamageMultPiece_type_id); 
	}

	auto
	VanityPerkWrenchDamage::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}
