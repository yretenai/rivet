...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED CameraDistanceTweakMultiplier : CameraDistanceTweak {
		constexpr static std::string_view type_name = "CameraDistanceTweakMultiplier";
		constexpr static rivet::rivet_type_id type_id = 0x3d7a3439;
		...
		explicit CameraDistanceTweakMultiplier() = default;
		explicit CameraDistanceTweakMultiplier([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<CameraDistanceTweakMultiplier>;
	};
} // namespace rivet::ddl::generated
