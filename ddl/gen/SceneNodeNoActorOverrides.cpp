...
#include <rivet/ddl/generated/SceneNodeNoActorOverrides.hpp>

namespace rivet::ddl::generated {
	SceneNodeNoActorOverrides::SceneNodeNoActorOverrides([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
	...
	[[nodiscard]] auto
	SceneNodeNoActorOverrides::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	SceneNodeNoActorOverrides::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<SceneNodeNoActorOverrides> {
		if (incoming_type_id == SceneNodeNoActorOverrides::type_id) {
			return std::make_shared<SceneNodeNoActorOverrides>(serialized);
		}
