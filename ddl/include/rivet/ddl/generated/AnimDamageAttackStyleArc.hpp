...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED AnimDamageAttackStyleArc : AnimDamageAttackStyleBase {
		constexpr const static std::string_view type_name = "AnimDamageAttackStyleArc";
		constexpr const static rivet::rivet_type_id type_id = 0xa6ec85c8;

		constexpr const static std::string_view ArcCenterHeight_type_name = "ArcCenterHeight";
		constexpr const static rivet::rivet_type_id ArcCenterHeight_type_id = 0x33055b3e;
