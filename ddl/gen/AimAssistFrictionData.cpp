...
namespace rivet::ddl::generated {
	AimAssistFrictionData::AimAssistFrictionData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		FactorMin = serialized->get_float(FactorMin_type_id, 1.000000f);
		FactorMax = serialized->get_float(FactorMax_type_id, 1.000000f);
		FactorCurve = serialized->get_float(FactorCurve_type_id, 1.000000f);
		SpeedScale = serialized->get_float(SpeedScale_type_id, 0.900000f); 
	}
