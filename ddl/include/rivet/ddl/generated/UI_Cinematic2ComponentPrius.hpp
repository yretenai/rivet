...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UI_Cinematic2ComponentPrius : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_Cinematic2ComponentPrius";
		constexpr static rivet::rivet_type_id type_id = 0x44ba921e;
		...
		explicit UI_Cinematic2ComponentPrius() = default;
		explicit UI_Cinematic2ComponentPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_Cinematic2ComponentPrius>;
	};
} // namespace rivet::ddl::generated
