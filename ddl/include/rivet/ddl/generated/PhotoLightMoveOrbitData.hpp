...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED PhotoLightMoveOrbitData : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "PhotoLightMoveOrbitData";
		constexpr static rivet::rivet_type_id type_id = 0x471d75f4;
		...
		constexpr static std::string_view OrbitRateScale_type_name = "OrbitRateScale";
		constexpr static rivet::rivet_type_id OrbitRateScale_type_id = 0x780e5b22;
		constexpr static std::string_view UpDownScale_type_name = "UpDownScale";
		constexpr static rivet::rivet_type_id UpDownScale_type_id = 0xe5460610;
		constexpr static std::string_view NearFarScale_type_name = "NearFarScale";
		constexpr static rivet::rivet_type_id NearFarScale_type_id = 0xd7b722f2;
		constexpr static std::string_view StartMoveScale_type_name = "StartMoveScale";
		constexpr static rivet::rivet_type_id StartMoveScale_type_id = 0x9f89367a;
		constexpr static std::string_view FinalMoveScale_type_name = "FinalMoveScale";
		constexpr static rivet::rivet_type_id FinalMoveScale_type_id = 0xff4a5e78;
		constexpr static std::string_view MoveScaleTime_type_name = "MoveScaleTime";
		constexpr static rivet::rivet_type_id MoveScaleTime_type_id = 0xfa31f80b; 
