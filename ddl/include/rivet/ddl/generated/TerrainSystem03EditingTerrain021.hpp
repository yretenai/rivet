...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED TerrainSystem03EditingTerrain021 : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "TerrainSystem03EditingTerrain021";
		constexpr static rivet::rivet_type_id type_id = 0x2f45c568;
		...
		explicit TerrainSystem03EditingTerrain021() = default;
		explicit TerrainSystem03EditingTerrain021([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TerrainSystem03EditingTerrain021>;
	};
} // namespace rivet::ddl::generated
