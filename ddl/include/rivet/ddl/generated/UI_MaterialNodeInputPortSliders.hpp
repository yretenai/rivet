...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortSliders : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortSliders";
		constexpr static rivet::rivet_type_id type_id = 0xc4cfbed8;
		...
		explicit UI_MaterialNodeInputPortSliders() = default;
		explicit UI_MaterialNodeInputPortSliders([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortSliders>;
	};
} // namespace rivet::ddl::generated
