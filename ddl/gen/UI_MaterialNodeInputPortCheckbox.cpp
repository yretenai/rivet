...
#include <rivet/ddl/generated/UI_MaterialNodeInputPortCheckbox.hpp>

namespace rivet::ddl::generated {
	UI_MaterialNodeInputPortCheckbox::UI_MaterialNodeInputPortCheckbox([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		Checkbox = serialized->get_bool(Checkbox_type_id, false); 
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortCheckbox::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortCheckbox::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortCheckbox> {
		if (incoming_type_id == UI_MaterialNodeInputPortCheckbox::type_id) {
			return std::make_shared<UI_MaterialNodeInputPortCheckbox>(serialized);
		}
