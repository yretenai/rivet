...
namespace rivet::ddl::generated {
	HeroHookshotConfig::HeroHookshotConfig([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		IdealCableLength = serialized->get_float(IdealCableLength_type_id);
		...
		AnimMaxTargetSpeed = serialized->get_float(AnimMaxTargetSpeed_type_id); 
	}

	auto
	HeroHookshotConfig::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}
