...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED Cinematic2PostCompositeMaterialActionDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2PostCompositeMaterialActionDef";
		constexpr static rivet::rivet_type_id type_id = 0x6b81e0b0;
		...
		explicit Cinematic2PostCompositeMaterialActionDef() = default;
		explicit Cinematic2PostCompositeMaterialActionDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2PostCompositeMaterialActionDef>;
	};
} // namespace rivet::ddl::generated
