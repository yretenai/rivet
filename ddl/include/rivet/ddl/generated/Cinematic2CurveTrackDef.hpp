...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2CurveTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2CurveTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xbf0ae1a6;
		...
		explicit Cinematic2CurveTrackDef() = default;
		explicit Cinematic2CurveTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2CurveTrackDef>;
	};
} // namespace rivet::ddl::generated
