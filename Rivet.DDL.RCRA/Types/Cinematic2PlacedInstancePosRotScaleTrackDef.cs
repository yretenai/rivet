...
public class Cinematic2PlacedInstancePosRotScaleTrackDef : DDLObjectType, IDDLObjectType<Cinematic2PlacedInstancePosRotScaleTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xcb65dfd9u);

	public Cinematic2PlacedInstancePosRotScaleTrackDef(DDLObject ddl) : base(ddl) {
