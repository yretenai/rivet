...
namespace rivet::ddl::generated {
	AnimActorChunkData::AnimActorChunkData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): AnimChunkData(serialized) {
	...
	[[nodiscard]] auto
	AnimActorChunkData::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	AnimActorChunkData::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<AnimActorChunkData> {
		if (incoming_type_id == AnimActorChunkData::type_id) {
			return std::make_shared<AnimActorChunkData>(serialized);
		}
