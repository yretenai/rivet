...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED BotConfigStatusEffects : ConfigBase {
		constexpr static std::string_view type_name = "BotConfigStatusEffects";
		constexpr static rivet::rivet_type_id type_id = 0x44fbf2e9;

		constexpr static std::string_view FireTrackerPrius_type_name = "FireTrackerPrius";
		constexpr static rivet::rivet_type_id FireTrackerPrius_type_id = 0x1e88c992;
		...
		constexpr static std::string_view FossilizeTrackerPrius_type_name = "FossilizeTrackerPrius";
		constexpr static rivet::rivet_type_id FossilizeTrackerPrius_type_id = 0x805ee9bf;
		...
		constexpr static std::string_view MagnaMissileTrackerPrius_type_name = "MagnaMissileTrackerPrius";
		constexpr static rivet::rivet_type_id MagnaMissileTrackerPrius_type_id = 0x20a01904;
		...
		constexpr static std::string_view ProtoGrenadeTrackerPrius_type_name = "ProtoGrenadeTrackerPrius";
		constexpr static rivet::rivet_type_id ProtoGrenadeTrackerPrius_type_id = 0x35a2dd0f;
		constexpr static std::string_view WarpRifleImplodeTrackerPrius_type_name = "WarpRifleImplodeTrackerPrius";
		constexpr static rivet::rivet_type_id WarpRifleImplodeTrackerPrius_type_id = 0x2cf648dc;
		constexpr static std::string_view RynotizeTrackerPrius_type_name = "RynotizeTrackerPrius";
		constexpr static rivet::rivet_type_id RynotizeTrackerPrius_type_id = 0x21aa1e39; 
