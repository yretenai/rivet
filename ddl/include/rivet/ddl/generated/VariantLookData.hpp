...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED VariantLookData : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VariantLookData";
		constexpr static rivet::rivet_type_id type_id = 0x452d50e3;
		...
		constexpr static std::string_view PaletteIndexMin_type_name = "PaletteIndexMin";
		constexpr static rivet::rivet_type_id PaletteIndexMin_type_id = 0xa7b38e02;
		constexpr static std::string_view PaletteIndexMax_type_name = "PaletteIndexMax";
		constexpr static rivet::rivet_type_id PaletteIndexMax_type_id = 0x9bbeb15b;
		constexpr static std::string_view HSLRangeMin_type_name = "HSLRangeMin";
		constexpr static rivet::rivet_type_id HSLRangeMin_type_id = 0x2f68a99c;
		constexpr static std::string_view HSLRangeMax_type_name = "HSLRangeMax";
		constexpr static rivet::rivet_type_id HSLRangeMax_type_id = 0x136596c5; 
