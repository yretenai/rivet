...
namespace rivet::ddl::generated {
	TerrainPaintingPref::TerrainPaintingPref([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		BrushParamAlpha = serialized->get_float(BrushParamAlpha_type_id, 1.000000f);
		BrushParamAlphaFlow = serialized->get_float(BrushParamAlphaFlow_type_id, 1.000000f);
		BrushParamBlurSpeed = serialized->get_float(BrushParamBlurSpeed_type_id, 1.000000f);
		BrushParamHeight = serialized->get_float(BrushParamHeight_type_id, 1.000000f);
		BrushParamHeightFlow = serialized->get_float(BrushParamHeightFlow_type_id, 1.000000f);
		BrushParamRamp = serialized->get_float(BrushParamRamp_type_id, 1.000000f);
		BrushParamSharpenSpeed = serialized->get_float(BrushParamSharpenSpeed_type_id, 1.000000f);
		...
		RadiusClipboard = serialized->get_float(RadiusClipboard_type_id, 1.000000f);
		...
		FalloffClipboard = serialized->get_float(FalloffClipboard_type_id, 0.350000f);
		...
		RotationDegrees = serialized->get_float(RotationDegrees_type_id, 0.000000f);
		RotationDegreesClipboard = serialized->get_float(RotationDegreesClipboard_type_id, 0.000000f);
		...
		HeightClampValue = serialized->get_float(HeightClampValue_type_id, 0.000000f);
