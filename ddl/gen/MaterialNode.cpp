...
namespace rivet::ddl::generated {
	MaterialNode::MaterialNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		ForceVelocityPass = serialized->get_bool(ForceVelocityPass_type_id, false);
		ForceForwardPass = serialized->get_bool(ForceForwardPass_type_id, false);
		ForceHQFrameGrab = serialized->get_bool(ForceHQFrameGrab_type_id, false);
