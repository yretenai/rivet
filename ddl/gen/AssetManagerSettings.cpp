...
namespace rivet::ddl::generated {
	AssetManagerSettings::AssetManagerSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		VisualEffectSingleFrameMax = serialized->get_uint32(VisualEffectSingleFrameMax_type_id, 3932160u);
		TextureStreamBufferSize = serialized->get_uint32(TextureStreamBufferSize_type_id, 16777216u);
		TextureLowMipsMaxSize = serialized->get_uint32(TextureLowMipsMaxSize_type_id, 62914560u);
		ZoneGameplayDataCallbackMax = serialized->get_int32(ZoneGameplayDataCallbackMax_type_id, 32u);
		ZoneManagerCallbackMax = serialized->get_int32(ZoneManagerCallbackMax_type_id, 4u);
		ZoneManagerCombinedScriptActionTypeMax = serialized->get_int32(ZoneManagerCombinedScriptActionTypeMax_type_id, 32u);
		ZoneLightBinMax = serialized->get_uint32(ZoneLightBinMax_type_id, 64u);
		LightGridUnpackBufferSize = serialized->get_uint32(LightGridUnpackBufferSize_type_id, 16777216u);
		MaxEnvProbeEntries = serialized->get_uint32(MaxEnvProbeEntries_type_id, 512u);
		AssetLoaderTempAllocSize = serialized->get_uint32(AssetLoaderTempAllocSize_type_id, 12582192u);
		MaxVertexShaders = serialized->get_uint32(MaxVertexShaders_type_id, 1024u);
		MaxHullShaders = serialized->get_uint32(MaxHullShaders_type_id, 512u);
		MaxDomainShaders = serialized->get_uint32(MaxDomainShaders_type_id, 512u);
		MaxPixelShaders = serialized->get_uint32(MaxPixelShaders_type_id, 6400u);
