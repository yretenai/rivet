...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED MaterialGraphComment : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "MaterialGraphComment";
		constexpr static rivet::rivet_type_id type_id = 0x487606ea;

		constexpr static std::string_view CommentId_type_name = "CommentId";
		constexpr static rivet::rivet_type_id CommentId_type_id = 0xe46d5cf9;
		...
		explicit MaterialGraphComment() = default;
		explicit MaterialGraphComment([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<MaterialGraphComment>;
	};
} // namespace rivet::ddl::generated
