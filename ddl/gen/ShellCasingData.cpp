...
namespace rivet::ddl::generated {
	ShellCasingData::ShellCasingData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		LifetimeMin = serialized->get_float(LifetimeMin_type_id, 20.000000f);
		LifetimeMax = serialized->get_float(LifetimeMax_type_id, 40.000000f);
		EjectSpeedMin = serialized->get_float(EjectSpeedMin_type_id, 10.000000f);
		EjectSpeedMax = serialized->get_float(EjectSpeedMax_type_id, 25.000000f);
