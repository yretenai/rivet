...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED GadgetIconData : rivet::structures::rivet_ddl_base {
		...
		rivet::ddl::generated::xce74edfb Gadget {};
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<GadgetIconData>;
	};
} // namespace rivet::ddl::generated
