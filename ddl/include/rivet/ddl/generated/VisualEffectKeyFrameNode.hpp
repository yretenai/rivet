...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED VisualEffectKeyFrameNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectKeyFrameNode";
		constexpr static rivet::rivet_type_id type_id = 0x904eb287;
		...
		constexpr static std::string_view InputPort_LifeTimeOverride_type_name = "InputPort_LifeTimeOverride";
		constexpr static rivet::rivet_type_id InputPort_LifeTimeOverride_type_id = 0x65a34ae4;
		constexpr static std::string_view Collection_type_name = "Collection";
		constexpr static rivet::rivet_type_id Collection_type_id = 0x277b3b0b; 

		explicit VisualEffectKeyFrameNode() = default;
		explicit VisualEffectKeyFrameNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::VisualEffectFloat> InputPort_LifeTimeOverride {};
		std::shared_ptr<rivet::ddl::generated::KeyFrameCollection> Collection {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectKeyFrameNode>;
	};
} // namespace rivet::ddl::generated
