...
namespace rivet::ddl::generated {
	DebugSettings::DebugSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		DrawCommandLine = serialized->get_bool(DrawCommandLine_type_id, false);
		...
		MatOverrideVolumesEnable = serialized->get_bool(MatOverrideVolumesEnable_type_id, false);
		DrawLightingCondition = serialized->get_bool(DrawLightingCondition_type_id, false);
		DisableAllPrefabSpawning = serialized->get_bool(DisableAllPrefabSpawning_type_id, false);
		VignetteMemTest = serialized->get_bool(VignetteMemTest_type_id, false);
		...
		PlayDialogAudit = serialized->get_bool(PlayDialogAudit_type_id, false); 
	}
