...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED LandingBirdSystemConfig : ConfigBase {
		constexpr static std::string_view type_name = "LandingBirdSystemConfig";
		constexpr static rivet::rivet_type_id type_id = 0xe2d25465;
		...
		constexpr static std::string_view PostFleeCooldown_type_name = "PostFleeCooldown";
		constexpr static rivet::rivet_type_id PostFleeCooldown_type_id = 0x6ebd89a8;
		constexpr static std::string_view MaxIdleSpeed_type_name = "MaxIdleSpeed";
		constexpr static rivet::rivet_type_id MaxIdleSpeed_type_id = 0x40189a17;
		constexpr static std::string_view IdleSpawnDelay_type_name = "IdleSpawnDelay";
		constexpr static rivet::rivet_type_id IdleSpawnDelay_type_id = 0x7370d587;
		constexpr static std::string_view LandCircleOffsetXZ_type_name = "LandCircleOffsetXZ";
		constexpr static rivet::rivet_type_id LandCircleOffsetXZ_type_id = 0xafa9accd;
		constexpr static std::string_view LandCircleRadiusXZ_type_name = "LandCircleRadiusXZ";
		constexpr static rivet::rivet_type_id LandCircleRadiusXZ_type_id = 0xbf7ed98b;
		constexpr static std::string_view MaxLandHeightDiff_type_name = "MaxLandHeightDiff";
		constexpr static rivet::rivet_type_id MaxLandHeightDiff_type_id = 0x10f7a304;
		constexpr static std::string_view MaxLandNormalAngle_type_name = "MaxLandNormalAngle";
		constexpr static rivet::rivet_type_id MaxLandNormalAngle_type_id = 0xae60ccd2;
		constexpr static std::string_view FleeDestroyOffscreenDelay_type_name = "FleeDestroyOffscreenDelay";
		constexpr static rivet::rivet_type_id FleeDestroyOffscreenDelay_type_id = 0xc3bae185;
