...
namespace rivet::ddl::generated {
	Cinematic2PaneDef::Cinematic2PaneDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		NearClipPlane = serialized->get_float(NearClipPlane_type_id, 0.100000f);
		FarClipPlane = serialized->get_float(FarClipPlane_type_id, 1000.000000f);
		LodScaleMultiplier = serialized->get_float(LodScaleMultiplier_type_id, 1.000000f);
		ImpostorHQBaseDistance = serialized->get_float(ImpostorHQBaseDistance_type_id, 0.000000f);
