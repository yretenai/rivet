...
[DDLRegistration(0xa6a503b7u)]
public class DevstatsHighContrastMaterialsDisabledEvent : EventBase, IDDLObjectType<DevstatsHighContrastMaterialsDisabledEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0xa6a503b7u);

	public DevstatsHighContrastMaterialsDisabledEvent(DDLObject ddl) : base(ddl) {
	...
	public new static DevstatsHighContrastMaterialsDisabledEvent Create(DDLObject ddl) => new(ddl);
}
