...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED StatusEffectFreezeConfig : StatusEffectConfig {
		...
		std::shared_ptr<rivet::ddl::generated::FreezeShaderData> ShaderData {};
		std::shared_ptr<rivet::ddl::generated::FreezeShatterData> ShatterData {};
		std::shared_ptr<rivet::ddl::generated::FreezeSlideData> SlideData {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<StatusEffectFreezeConfig>;
	};
} // namespace rivet::ddl::generated
