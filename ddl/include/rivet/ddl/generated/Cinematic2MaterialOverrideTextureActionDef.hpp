...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED Cinematic2MaterialOverrideTextureActionDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2MaterialOverrideTextureActionDef";
		constexpr static rivet::rivet_type_id type_id = 0x39c4b8c;
		...
		explicit Cinematic2MaterialOverrideTextureActionDef() = default;
		explicit Cinematic2MaterialOverrideTextureActionDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2MaterialOverrideTextureActionDef>;
	};
} // namespace rivet::ddl::generated
