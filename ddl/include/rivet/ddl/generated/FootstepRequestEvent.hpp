...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED FootstepRequestEvent : GroundEvent {
		constexpr static std::string_view type_name = "FootstepRequestEvent";
		constexpr static rivet::rivet_type_id type_id = 0xde7e6327;
		...
		explicit FootstepRequestEvent() = default;
		explicit FootstepRequestEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<FootstepRequestEvent>;
	};
} // namespace rivet::ddl::generated
