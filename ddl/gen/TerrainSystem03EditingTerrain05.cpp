...
#include <rivet/ddl/generated/TerrainSystem03EditingTerrain05.hpp>

namespace rivet::ddl::generated {
	TerrainSystem03EditingTerrain05::TerrainSystem03EditingTerrain05([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
	...
	[[nodiscard]] auto
	TerrainSystem03EditingTerrain05::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	TerrainSystem03EditingTerrain05::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TerrainSystem03EditingTerrain05> {
		if (incoming_type_id == TerrainSystem03EditingTerrain05::type_id) {
			return std::make_shared<TerrainSystem03EditingTerrain05>(serialized);
		}
