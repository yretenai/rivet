...
namespace rivet::ddl::generated {
	ModelDef::ModelDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		GeomLodMaxJointInfl0 = serialized->get_uint8(GeomLodMaxJointInfl0_type_id);
		GeomLodMaxJointInfl1 = serialized->get_uint8(GeomLodMaxJointInfl1_type_id);
		GeomLodMaxJointInfl2 = serialized->get_uint8(GeomLodMaxJointInfl2_type_id);
		GeomLodMaxJointInfl3 = serialized->get_uint8(GeomLodMaxJointInfl3_type_id);
		GeomLodMaxJointInfl4 = serialized->get_uint8(GeomLodMaxJointInfl4_type_id);
		GeomLodMaxJointInfl5 = serialized->get_uint8(GeomLodMaxJointInfl5_type_id);
		PerfProfileMaxLod = serialized->unwrap_into<rivet::ddl::generated::PerfProfileLodMaxBase>(PerfProfileMaxLod_type_id);
		FadeOutDist = serialized->get_int16(FadeOutDist_type_id);
		ShadowFadeDist = serialized->get_uint16(ShadowFadeDist_type_id);
		ShadowCastingLoD = serialized->get_int16(ShadowCastingLoD_type_id);
		...
		SkipRainSplashes = serialized->get_bool(SkipRainSplashes_type_id);
		...
		SkipImpostorGeometry = serialized->get_bool(SkipImpostorGeometry_type_id);
		...
		ForceCpuSkinning = serialized->get_bool(ForceCpuSkinning_type_id);
		PhysicsSettings = serialized->unwrap_into<rivet::ddl::generated::ModelPhysicsSettings>(PhysicsSettings_type_id);
		IsFacialAnim = serialized->get_bool(IsFacialAnim_type_id);
		SplineModel = serialized->get_bool(SplineModel_type_id);
		IsShrub = serialized->get_bool(IsShrub_type_id);
		HibernateMode = serialized->get_enum<rivet::ddl::generated::HibernateMode>(HibernateMode_type_id, rivet::ddl::generated::HibernateMode_values);
		OccluderType = serialized->get_enum<rivet::ddl::generated::OccluderType>(OccluderType_type_id, rivet::ddl::generated::OccluderType_values);
		AmbientShadowType = serialized->get_enum<rivet::ddl::generated::AmbientShadowType>(AmbientShadowType_type_id, rivet::ddl::generated::AmbientShadowType_values);
		CinematicShadowMode = serialized->get_enum<rivet::ddl::generated::CinematicShadowMode>(CinematicShadowMode_type_id, rivet::ddl::generated::CinematicShadowMode_values);
		OptimizeUVMode = serialized->get_enum<rivet::ddl::generated::OptimizeUVMode>(OptimizeUVMode_type_id, rivet::ddl::generated::OptimizeUVMode_values);
		AVMaterial = serialized->get_string(AVMaterial_type_id);
		AudioMaterial = serialized->get_string(AudioMaterial_type_id);
		VertexRange = serialized->get_float(VertexRange_type_id);
		VertexRangeAnimMult = serialized->get_float(VertexRangeAnimMult_type_id);
		...
		ExcludeFromGame = serialized->get_bool(ExcludeFromGame_type_id);
		DelayStreaming = serialized->get_bool(DelayStreaming_type_id);
