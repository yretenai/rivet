...
#include <rivet/ddl/generated/ConfigDef.hpp>

namespace rivet::ddl::generated {
	ConfigDef::ConfigDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
	...
	[[nodiscard]] auto
	ConfigDef::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	ConfigDef::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ConfigDef> {
		if (incoming_type_id == ConfigDef::type_id) {
			return std::make_shared<ConfigDef>(serialized);
		}
