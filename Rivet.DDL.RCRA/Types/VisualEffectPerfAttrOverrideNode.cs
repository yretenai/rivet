...
public class VisualEffectPerfAttrOverrideNode : DDLObjectType, IDDLObjectType<VisualEffectPerfAttrOverrideNode> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xfabd1c9eu);

	public VisualEffectPerfAttrOverrideNode(DDLObject ddl) : base(ddl) {
