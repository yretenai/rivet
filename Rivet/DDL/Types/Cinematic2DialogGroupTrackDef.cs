...
public class Cinematic2DialogGroupTrackDef : DDLObjectType, IDDLObjectType<Cinematic2DialogGroupTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x249e5601u);

	public Cinematic2DialogGroupTrackDef(DDLObject ddl) : base(ddl) {
