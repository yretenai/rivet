...
namespace rivet::ddl::generated {
	BotComboMoveFinaleSweepChase::BotComboMoveFinaleSweepChase([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): BotComboMoveBase(serialized) {
		...
		PlaneSpawnPos = serialized->get_uint64(PlaneSpawnPos_type_id, 0ull);
		PlaneStartPos = serialized->get_uint64(PlaneStartPos_type_id, 0ull);
		PlaneEndPos = serialized->get_uint64(PlaneEndPos_type_id, 0ull);
		TurnRateMin = serialized->get_float(TurnRateMin_type_id, 0.000000f);
		TurnRateMax = serialized->get_float(TurnRateMax_type_id, 0.000000f); 
	}
