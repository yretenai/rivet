...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED CameraShakingAxisData : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "CameraShakingAxisData";
		constexpr static rivet::rivet_type_id type_id = 0x38a1bf9;

		constexpr static std::string_view CurveOne_type_name = "CurveOne";
		constexpr static rivet::rivet_type_id CurveOne_type_id = 0xfef79d5a;
		constexpr static std::string_view CurveTwo_type_name = "CurveTwo";
		constexpr static rivet::rivet_type_id CurveTwo_type_id = 0x955191cd;
		constexpr static std::string_view CurveThree_type_name = "CurveThree";
		constexpr static rivet::rivet_type_id CurveThree_type_id = 0xc08ae25f; 
