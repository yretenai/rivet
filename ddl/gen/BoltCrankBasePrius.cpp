...
namespace rivet::ddl::generated {
	BoltCrankBasePrius::BoltCrankBasePrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		CrankTimeMax = serialized->get_float(CrankTimeMax_type_id);
		MemoryResetSpeed = serialized->get_float(MemoryResetSpeed_type_id);
		MemoryResetWait = serialized->get_float(MemoryResetWait_type_id);
