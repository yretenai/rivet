...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsHighContrastBackgroundDisabledEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsHighContrastBackgroundDisabledEvent";
		constexpr static rivet::rivet_type_id type_id = 0x14732c45;
		...
		explicit DevstatsHighContrastBackgroundDisabledEvent() = default;
		explicit DevstatsHighContrastBackgroundDisabledEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsHighContrastBackgroundDisabledEvent>;
	};
} // namespace rivet::ddl::generated
