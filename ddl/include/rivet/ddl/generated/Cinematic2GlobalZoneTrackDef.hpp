...
namespace rivet::ddl::generated {
	struct Cinematic2ZoneActionDef;
	struct Cinematic2TrackTagsDef; 

	struct RIVET_DDL_SHARED Cinematic2GlobalZoneTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2GlobalZoneTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xac49f023;
		...
		explicit Cinematic2GlobalZoneTrackDef() = default;
		explicit Cinematic2GlobalZoneTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		bool Global {};
		std::vector<std::shared_ptr<rivet::ddl::generated::Cinematic2ZoneActionDef>> Actions {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2GlobalZoneTrackDef>;
	};
} // namespace rivet::ddl::generated
