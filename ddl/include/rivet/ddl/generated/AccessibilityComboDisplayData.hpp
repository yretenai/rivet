...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED AccessibilityComboDisplayData : rivet::structures::rivet_ddl_base {
		...
		std::shared_ptr<rivet::ddl::generated::ComboDisplayDataBase> Combo {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<AccessibilityComboDisplayData>;
	};
} // namespace rivet::ddl::generated
