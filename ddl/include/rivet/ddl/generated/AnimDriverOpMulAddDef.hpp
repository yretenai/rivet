...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED AnimDriverOpMulAddDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "AnimDriverOpMulAddDef";
		constexpr static rivet::rivet_type_id type_id = 0xdbf91f9f;
		...
		constexpr static std::string_view Mul_type_name = "Mul";
		constexpr static rivet::rivet_type_id Mul_type_id = 0x83570868;
		constexpr static std::string_view Add_type_name = "Add";
		constexpr static rivet::rivet_type_id Add_type_id = 0xd74f5a2e; 

		explicit AnimDriverOpMulAddDef() = default;
		explicit AnimDriverOpMulAddDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<AnimDriverOpMulAddDef>;
	};
} // namespace rivet::ddl::generated
