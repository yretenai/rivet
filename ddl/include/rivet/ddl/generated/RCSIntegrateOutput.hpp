...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED RCSIntegrateOutput : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "RCSIntegrateOutput";
		constexpr static rivet::rivet_type_id type_id = 0x9eba6926;
		...
		explicit RCSIntegrateOutput() = default;
		explicit RCSIntegrateOutput([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<RCSIntegrateOutput>;
	};
} // namespace rivet::ddl::generated
