...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DamageModifierInnerOuterPrius : DamageModifierOutgoingPrius {
		...
		std::shared_ptr<rivet::ddl::generated::DamageInnerOuterData> DamageData {};
		uint32_t RequestID {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DamageModifierInnerOuterPrius>;
	};
} // namespace rivet::ddl::generated
