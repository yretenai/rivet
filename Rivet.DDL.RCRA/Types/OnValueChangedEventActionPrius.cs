...
public class OnValueChangedEventActionPrius : DDLObjectType, IDDLObjectType<OnValueChangedEventActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xf04abda9u);

	public OnValueChangedEventActionPrius(DDLObject ddl) : base(ddl) {
