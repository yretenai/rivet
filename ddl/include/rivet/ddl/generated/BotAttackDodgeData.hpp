...
#include <rivet/ddl/generated/bitsets/xa672d722.hpp> 
...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED BotAttackDodgeData : rivet::structures::rivet_ddl_base {
		...
		rivet::ddl::generated::xa672d722 Properties {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<BotAttackDodgeData>;
	};
} // namespace rivet::ddl::generated
