...
namespace rivet::ddl::generated {
	ParticlesDef::ParticlesDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		NearFadeDistance = serialized->get_float(NearFadeDistance_type_id, 1.000000f);
		MaxDrawDistance = serialized->get_float(MaxDrawDistance_type_id, 24.000000f);
		WindInfluence = serialized->get_float(WindInfluence_type_id, 1.500000f);
		Turbulence = serialized->get_float(Turbulence_type_id, 0.300000f);
		Density = serialized->get_float(Density_type_id, 0.700000f);
		Speed = serialized->get_float(Speed_type_id, -2.000000f);
		Size = serialized->get_float(Size_type_id, 0.010000f);
		...
		ExposureDuration = serialized->get_float(ExposureDuration_type_id, 0.400000f);
		MotionStretchMax = serialized->get_float(MotionStretchMax_type_id, 25.000000f);
		MotionStretchMaxFar = serialized->get_float(MotionStretchMaxFar_type_id, 25.000000f);
		RainBloomInfluence = serialized->get_float(RainBloomInfluence_type_id, 4.000000f); 
	}
