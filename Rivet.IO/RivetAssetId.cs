...
public record struct RivetAssetId : IEquatable<ulong>, IEquatable<string> {
	public const ulong Basis = 0xc96c5795d7870f42;

	private static ulong[] CRC64Table { get; } = [
	...
	public RivetAssetIdFlags Flags => (RivetAssetIdFlags) (Value >> 62);

	public static implicit operator ulong(RivetAssetId rivetAssetId) => rivetAssetId.Value;
	public static implicit operator RivetAssetId(ulong hash) => new(hash);
