...
public class ImpostorDef : DDLObjectType, IDDLObjectType<ImpostorDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x4c1cc5f1u);

	public ImpostorDef(DDLObject ddl) : base(ddl) {
