...
namespace rivet::ddl::generated {
	struct HealthOutputPlugSignal; 

	struct RIVET_DDL_SHARED HealthNodeDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "HealthNodeDef";
		constexpr static rivet::rivet_type_id type_id = 0x66d82969;
		...
		explicit HealthNodeDef() = default;
		explicit HealthNodeDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		float X {};
		float Y {};
		std::vector<std::shared_ptr<rivet::ddl::generated::HealthOutputPlugSignal>> Outputs {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<HealthNodeDef>;
	};
} // namespace rivet::ddl::generated
