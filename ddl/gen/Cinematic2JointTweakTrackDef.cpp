...
#include <rivet/ddl/generated/Cinematic2JointTweakTrackDef.hpp>
...
namespace rivet::ddl::generated {
	...
	[[nodiscard]] auto
	Cinematic2JointTweakTrackDef::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	Cinematic2JointTweakTrackDef::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2JointTweakTrackDef> {
		if (incoming_type_id == Cinematic2JointTweakTrackDef::type_id) {
			return std::make_shared<Cinematic2JointTweakTrackDef>(serialized);
		}
