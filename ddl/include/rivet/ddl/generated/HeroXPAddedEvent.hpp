...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED HeroXPAddedEvent : EventBase {
		constexpr static std::string_view type_name = "HeroXPAddedEvent";
		constexpr static rivet::rivet_type_id type_id = 0xa4e33ea7;
		...
		explicit HeroXPAddedEvent() = default;
		explicit HeroXPAddedEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<HeroXPAddedEvent>;
	};
} // namespace rivet::ddl::generated
