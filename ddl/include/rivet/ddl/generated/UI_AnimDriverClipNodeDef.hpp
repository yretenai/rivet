...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UI_AnimDriverClipNodeDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_AnimDriverClipNodeDef";
		constexpr static rivet::rivet_type_id type_id = 0xd4c4d5eb;
		...
		explicit UI_AnimDriverClipNodeDef() = default;
		explicit UI_AnimDriverClipNodeDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_AnimDriverClipNodeDef>;
	};
} // namespace rivet::ddl::generated
