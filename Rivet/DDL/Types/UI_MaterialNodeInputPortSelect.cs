...
public class UI_MaterialNodeInputPortSelect : DDLObjectType, IDDLObjectType<UI_MaterialNodeInputPortSelect> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x2ac19a4du);

	public UI_MaterialNodeInputPortSelect(DDLObject ddl) : base(ddl) {
