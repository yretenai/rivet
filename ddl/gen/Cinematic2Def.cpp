...
namespace rivet::ddl::generated {
	Cinematic2Def::Cinematic2Def([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		PreviewLightingCondition = serialized->get_enum<rivet::ddl::generated::LightingConditions>(PreviewLightingCondition_type_id, rivet::ddl::generated::LightingConditions_values);
		Looping = serialized->get_bool(Looping_type_id);
		Letterboxed = serialized->get_bool(Letterboxed_type_id);
		EnableStreaming = serialized->get_bool(EnableStreaming_type_id);
		IsQte = serialized->get_bool(IsQte_type_id);
		Skippable = serialized->get_bool(Skippable_type_id);
		ResetOnFinished = serialized->get_bool(ResetOnFinished_type_id);
		MayaPlayBackCompensate = serialized->get_bool(MayaPlayBackCompensate_type_id);
		OnEnterCameraTransitionDuration = serialized->get_float(OnEnterCameraTransitionDuration_type_id);
		OnExitCameraTransitionDuration = serialized->get_float(OnExitCameraTransitionDuration_type_id);
		...
		ActorCustomizationConfig = serialized->get_string(ActorCustomizationConfig_type_id);
