...
public class DivideActionPrius : DDLObjectType, IDDLObjectType<DivideActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x39130a71u);

	public DivideActionPrius(DDLObject ddl) : base(ddl) {
