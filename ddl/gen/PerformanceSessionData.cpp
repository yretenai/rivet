...
namespace rivet::ddl::generated {
	PerformanceSessionData::PerformanceSessionData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		SaveRequired = serialized->get_uint8(SaveRequired_type_id);
		Looping = serialized->get_uint8(Looping_type_id);
		Playing = serialized->get_uint8(Playing_type_id);
		PerformanceClipId = serialized->get_uint32(PerformanceClipId_type_id);
		BodyActorHandle = serialized->get_uint32(BodyActorHandle_type_id);
