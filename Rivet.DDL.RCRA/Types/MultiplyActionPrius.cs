...
public class MultiplyActionPrius : DDLObjectType, IDDLObjectType<MultiplyActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x07f9c829u);

	public MultiplyActionPrius(DDLObject ddl) : base(ddl) {
