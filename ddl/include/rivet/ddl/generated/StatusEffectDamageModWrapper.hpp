...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED StatusEffectDamageModWrapper : rivet::structures::rivet_ddl_base {
		...
		std::shared_ptr<rivet::ddl::generated::DamageModifierIncomingPrius> DamageMod {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<StatusEffectDamageModWrapper>;
	};
} // namespace rivet::ddl::generated
