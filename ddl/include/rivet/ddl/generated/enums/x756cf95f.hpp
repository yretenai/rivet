...
namespace rivet::ddl::generated {
	constexpr const static std::string_view x756cf95f_type_name = "x756cf95f";
	constexpr const static rivet::rivet_type_id x756cf95f_type_id = 0x756cf95f;

	constexpr const static std::array<std::string_view, 14> x756cf95f_values = {
