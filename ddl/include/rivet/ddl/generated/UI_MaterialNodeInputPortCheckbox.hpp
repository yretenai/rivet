...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortCheckbox : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortCheckbox";
		constexpr static rivet::rivet_type_id type_id = 0x818aec1b;
		...
		constexpr static std::string_view Checkbox_type_name = "Checkbox";
		constexpr static rivet::rivet_type_id Checkbox_type_id = 0xe47ab59d; 

		explicit UI_MaterialNodeInputPortCheckbox() = default;
		explicit UI_MaterialNodeInputPortCheckbox([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortCheckbox>;
	};
} // namespace rivet::ddl::generated
