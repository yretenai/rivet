...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsEmergentVOFailedEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsEmergentVOFailedEvent";
		constexpr static rivet::rivet_type_id type_id = 0x59e44649;
		...
		explicit DevstatsEmergentVOFailedEvent() = default;
		explicit DevstatsEmergentVOFailedEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsEmergentVOFailedEvent>;
	};
} // namespace rivet::ddl::generated
