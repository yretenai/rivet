...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED ModelBuildConfig : ConfigBase {
		...
		int32_t MaximumCollisionPolysPerNonstaticMesh {};
		rivet::ddl::generated::x9833bb27 WarnOnMoreThanMaxCollisionPolys {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ModelBuildConfig>;
	};
} // namespace rivet::ddl::generated
