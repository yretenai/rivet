...
namespace rivet::ddl::generated {
	struct BlockModifierOutPutSignal;
	struct PhysicsComponentPrius; 

	struct RIVET_DDL_SHARED PhysicsPropertyNodeDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "PhysicsPropertyNodeDef";
		constexpr static rivet::rivet_type_id type_id = 0x823014a;
		...
		explicit PhysicsPropertyNodeDef() = default;
		explicit PhysicsPropertyNodeDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::BlockModifierOutPutSignal> Output {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<PhysicsPropertyNodeDef>;
	};
} // namespace rivet::ddl::generated
