...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsPlayerDeathEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsPlayerDeathEvent";
		constexpr static rivet::rivet_type_id type_id = 0xd4ec8a36;
		...
		explicit DevstatsPlayerDeathEvent() = default;
		explicit DevstatsPlayerDeathEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsPlayerDeathEvent>;
	};
} // namespace rivet::ddl::generated
