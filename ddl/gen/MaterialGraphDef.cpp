...
namespace rivet::ddl::generated {
	MaterialGraphDef::MaterialGraphDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		FrameGrabOversize = serialized->get_float(FrameGrabOversize_type_id, 0.000000f);
		...
		PreviewIdLow = serialized->get_uint32(PreviewIdLow_type_id, 0u);
		PreviewIdHigh = serialized->get_uint32(PreviewIdHigh_type_id, 0u);
