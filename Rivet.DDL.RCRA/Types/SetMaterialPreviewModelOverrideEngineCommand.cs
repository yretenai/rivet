...
public class SetMaterialPreviewModelOverrideEngineCommand : DDLObjectType, IDDLObjectType<SetMaterialPreviewModelOverrideEngineCommand> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x754b49bbu);

	public SetMaterialPreviewModelOverrideEngineCommand(DDLObject ddl) : base(ddl) {
