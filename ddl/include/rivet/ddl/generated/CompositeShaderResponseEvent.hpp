...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED CompositeShaderResponseEvent : ResponseEvent {
		constexpr static std::string_view type_name = "CompositeShaderResponseEvent";
		constexpr static rivet::rivet_type_id type_id = 0x4c2ed47e;
		...
		constexpr static std::string_view Remove_type_name = "Remove";
		constexpr static rivet::rivet_type_id Remove_type_id = 0x56f85357; 

		explicit CompositeShaderResponseEvent() = default;
		explicit CompositeShaderResponseEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<CompositeShaderResponseEvent>;
	};
} // namespace rivet::ddl::generated
