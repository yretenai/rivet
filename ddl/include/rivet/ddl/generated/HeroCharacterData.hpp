...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED HeroCharacterData : rivet::structures::rivet_ddl_base {
		constexpr const static std::string_view type_name = "HeroCharacterData";
		constexpr const static rivet::rivet_type_id type_id = 0x95bc5fd6;
		...
		constexpr const static std::string_view HeroType_type_name = "HeroType";
		constexpr const static rivet::rivet_type_id HeroType_type_id = 0x1583d108;
		...
		constexpr const static std::string_view CharacterOptions_type_name = "CharacterOptions";
		constexpr const static rivet::rivet_type_id CharacterOptions_type_id = 0x4f11ccb; 
