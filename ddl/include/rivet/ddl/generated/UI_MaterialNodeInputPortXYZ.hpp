...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortXYZ : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortXYZ";
		constexpr static rivet::rivet_type_id type_id = 0xb3575d7d;
		...
		explicit UI_MaterialNodeInputPortXYZ() = default;
		explicit UI_MaterialNodeInputPortXYZ([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortXYZ>;
	};
} // namespace rivet::ddl::generated
