...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED AnimDriverOpClampDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "AnimDriverOpClampDef";
		constexpr static rivet::rivet_type_id type_id = 0xef1591c9;
		...
		explicit AnimDriverOpClampDef() = default;
		explicit AnimDriverOpClampDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<AnimDriverOpClampDef>;
	};
} // namespace rivet::ddl::generated
