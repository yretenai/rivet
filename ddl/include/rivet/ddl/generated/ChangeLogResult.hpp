...
#include <rivet/ddl/generated/enums/ChangeType.hpp>
...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ChangeLogResult : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "ChangeLogResult";
		constexpr static rivet::rivet_type_id type_id = 0xbea0c844;
		...
		explicit ChangeLogResult() = default;
		explicit ChangeLogResult([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		rivet::ddl::generated::ChangeType ChangeType {};
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ChangeLogResult>;
	};
} // namespace rivet::ddl::generated
