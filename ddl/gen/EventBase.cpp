...
namespace rivet::ddl::generated {
	EventBase::EventBase([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		Frame = serialized->get_uint32(Frame_type_id);
		SenderHandle = serialized->get_uint32(SenderHandle_type_id);
		TrackedNameHash = serialized->get_uint32(TrackedNameHash_type_id);
		EventLocatorHash = serialized->get_uint32(EventLocatorHash_type_id);
		SourceAnimDriverNameHash = serialized->get_uint32(SourceAnimDriverNameHash_type_id);
		SourceAnimDriverHandle = serialized->get_uint32(SourceAnimDriverHandle_type_id);
		Orientation = serialized->unwrap_into<rivet::ddl::generated::DDLTransform>(Orientation_type_id);
		RequireActivated = serialized->get_uint8(RequireActivated_type_id); 
	}
