...
public class Cinematic2PostCompositeMaterialActionDef : DDLObjectType, IDDLObjectType<Cinematic2PostCompositeMaterialActionDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x6b81e0b0u);

	public Cinematic2PostCompositeMaterialActionDef(DDLObject ddl) : base(ddl) {
