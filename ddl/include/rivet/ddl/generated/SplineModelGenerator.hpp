...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED SplineModelGenerator : SplineGenerator {
		constexpr static std::string_view type_name = "SplineModelGenerator";
		constexpr static rivet::rivet_type_id type_id = 0x16b74ee;
		...
		explicit SplineModelGenerator() = default;
		explicit SplineModelGenerator([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);

		std::shared_ptr<rivet::ddl::generated::CrossSectionBase> CrossSection {};
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<SplineModelGenerator>;
	};
} // namespace rivet::ddl::generated
