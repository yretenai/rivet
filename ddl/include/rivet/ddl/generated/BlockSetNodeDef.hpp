...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED BlockSetNodeDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "BlockSetNodeDef";
		constexpr static rivet::rivet_type_id type_id = 0xb7cbe4bd;
		...
		constexpr static std::string_view BlockSetAssetPath_type_name = "BlockSetAssetPath";
		constexpr static rivet::rivet_type_id BlockSetAssetPath_type_id = 0xcb79fba2;
		...
		explicit BlockSetNodeDef() = default;
		explicit BlockSetNodeDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		float X {};
		float Y {};
		std::vector<std::shared_ptr<rivet::ddl::generated::BlockNodeDef>> Blocks {};
		std::string_view BlockSetAssetPath {};
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<BlockSetNodeDef>;
	};
} // namespace rivet::ddl::generated
