...
namespace rivet::ddl::generated {
	ModelDef::ModelDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		GeomLodDist1 = serialized->get_uint16(GeomLodDist1_type_id, 15u);
		GeomLodDist2 = serialized->get_uint16(GeomLodDist2_type_id, 30u);
		GeomLodDist3 = serialized->get_uint16(GeomLodDist3_type_id, 110u);
		GeomLodDist4 = serialized->get_uint16(GeomLodDist4_type_id, 160u);
		GeomLodDist5 = serialized->get_uint16(GeomLodDist5_type_id, 210u);
		GeomLodMaxJointInfl0 = serialized->get_uint8(GeomLodMaxJointInfl0_type_id, 4u);
		GeomLodMaxJointInfl1 = serialized->get_uint8(GeomLodMaxJointInfl1_type_id, 4u);
		GeomLodMaxJointInfl2 = serialized->get_uint8(GeomLodMaxJointInfl2_type_id, 4u);
		GeomLodMaxJointInfl3 = serialized->get_uint8(GeomLodMaxJointInfl3_type_id, 2u);
		GeomLodMaxJointInfl4 = serialized->get_uint8(GeomLodMaxJointInfl4_type_id, 2u);
		GeomLodMaxJointInfl5 = serialized->get_uint8(GeomLodMaxJointInfl5_type_id, 1u);
		PerfProfileMaxLod = serialized->unwrap_into<rivet::ddl::generated::PerfProfileLodMaxBase>(PerfProfileMaxLod_type_id);
		FadeOutDist = serialized->get_int16(FadeOutDist_type_id, 0u);
		ShadowFadeDist = serialized->get_uint16(ShadowFadeDist_type_id, 0u);
		...
		VertexRange = serialized->get_float(VertexRange_type_id, 0.000000f);
		VertexRangeAnimMult = serialized->get_float(VertexRangeAnimMult_type_id, 2.000000f);
