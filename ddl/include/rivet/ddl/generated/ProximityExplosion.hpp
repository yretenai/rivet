...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED ProximityExplosion : GrenadeExplosionMode {
		constexpr static std::string_view type_name = "ProximityExplosion";
		constexpr static rivet::rivet_type_id type_id = 0x4faeb2e8;

		constexpr static std::string_view InFlightProximityRadius_type_name = "InFlightProximityRadius";
		constexpr static rivet::rivet_type_id InFlightProximityRadius_type_id = 0x24599452;
		constexpr static std::string_view ProximityRadius_type_name = "ProximityRadius";
		constexpr static rivet::rivet_type_id ProximityRadius_type_id = 0xf1185690;
		...
		constexpr static std::string_view MaxInFlightSpeed_type_name = "MaxInFlightSpeed";
		constexpr static rivet::rivet_type_id MaxInFlightSpeed_type_id = 0xbbd7aad3; 
