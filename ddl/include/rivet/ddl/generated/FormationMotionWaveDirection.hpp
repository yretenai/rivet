...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED FormationMotionWaveDirection : FormationMotionWaveBase {
		...
		std::shared_ptr<rivet::ddl::generated::DDLVector3> MotionDirection {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<FormationMotionWaveDirection>;
	};
} // namespace rivet::ddl::generated
