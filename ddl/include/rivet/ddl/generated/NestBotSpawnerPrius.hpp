...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED NestBotSpawnerPrius : NestBotBasePrius {
		constexpr static std::string_view type_name = "NestBotSpawnerPrius";
		constexpr static rivet::rivet_type_id type_id = 0x2ff70277;
		...
		explicit NestBotSpawnerPrius() = default;
		explicit NestBotSpawnerPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<NestBotSpawnerPrius>;
	};
} // namespace rivet::ddl::generated
