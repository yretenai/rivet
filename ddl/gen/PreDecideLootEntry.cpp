...
namespace rivet::ddl::generated {
	PreDecideLootEntry::PreDecideLootEntry([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		PickChance = serialized->get_float(PickChance_type_id, 1.000000f);
		...
		MaterialConstValue = serialized->get_float(MaterialConstValue_type_id, 1.000000f);
		LootIdNum = serialized->get_uint8(LootIdNum_type_id, 0u); 
	}
