...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ShotMotionBasePrius : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "ShotMotionBasePrius";
		constexpr static rivet::rivet_type_id type_id = 0xbbb4ed1b;
		...
		constexpr static std::string_view RespondToProjectiles_type_name = "RespondToProjectiles";
		constexpr static rivet::rivet_type_id RespondToProjectiles_type_id = 0xe4577ed3;
		constexpr static std::string_view IgnoreDeadBots_type_name = "IgnoreDeadBots";
		constexpr static rivet::rivet_type_id IgnoreDeadBots_type_id = 0x1f654a52;
		constexpr static std::string_view SendSyncMotionEvents_type_name = "SendSyncMotionEvents";
		constexpr static rivet::rivet_type_id SendSyncMotionEvents_type_id = 0xd3c00b25;
		constexpr static std::string_view HitMoveCollision_type_name = "HitMoveCollision";
		constexpr static rivet::rivet_type_id HitMoveCollision_type_id = 0x9e652c14;
		constexpr static std::string_view HitWaterCollision_type_name = "HitWaterCollision";
		constexpr static rivet::rivet_type_id HitWaterCollision_type_id = 0x27c2f21c;
		constexpr static std::string_view HitThrowables_type_name = "HitThrowables";
		constexpr static rivet::rivet_type_id HitThrowables_type_id = 0xe823a48f;
		constexpr static std::string_view HitCharacterMove_type_name = "HitCharacterMove";
		constexpr static rivet::rivet_type_id HitCharacterMove_type_id = 0xd5a99bda; 
