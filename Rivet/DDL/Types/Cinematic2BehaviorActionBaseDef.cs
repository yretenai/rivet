...
[DDLRegistration(0xddddec17u)]
public class Cinematic2BehaviorActionBaseDef : DDLObjectType, IDDLObjectType<Cinematic2BehaviorActionBaseDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xddddec17u);

	public Cinematic2BehaviorActionBaseDef(DDLObject ddl) : base(ddl) {
	...
	public static Cinematic2BehaviorActionBaseDef Create(DDLObject ddl) => new(ddl);
}
