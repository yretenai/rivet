...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED PrototypeButtonPressListenerPrius : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "PrototypeButtonPressListenerPrius";
		constexpr static rivet::rivet_type_id type_id = 0x9ffbe253;
		...
		explicit PrototypeButtonPressListenerPrius() = default;
		explicit PrototypeButtonPressListenerPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);

		rivet::ddl::generated::xe10f705b Button {};
		bool StartEnabled {};
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<PrototypeButtonPressListenerPrius>;
	};
} // namespace rivet::ddl::generated
