...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2AudioRtpcTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2AudioRtpcTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xf5e81824;
		...
		constexpr static std::string_view RtpcName_type_name = "RtpcName";
		constexpr static rivet::rivet_type_id RtpcName_type_id = 0x63940eb4; 

		explicit Cinematic2AudioRtpcTrackDef() = default;
		explicit Cinematic2AudioRtpcTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::string_view RtpcName {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2AudioRtpcTrackDef>;
	};
} // namespace rivet::ddl::generated
