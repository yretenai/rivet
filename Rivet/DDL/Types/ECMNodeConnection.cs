...
[DDLRegistration(0x1a96fc57u)]
public class ECMNodeConnection : DDLObjectType, IDDLObjectType<ECMNodeConnection> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x1a96fc57u);

	public ECMNodeConnection(DDLObject ddl) : base(ddl) {
	...
	public static ECMNodeConnection Create(DDLObject ddl) => new(ddl);
}
