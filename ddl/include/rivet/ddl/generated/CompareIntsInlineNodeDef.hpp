...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED CompareIntsInlineNodeDef : MathNodeBaseDef {
		constexpr static std::string_view type_name = "CompareIntsInlineNodeDef";
		constexpr static rivet::rivet_type_id type_id = 0x86dd200d;
		...
		explicit CompareIntsInlineNodeDef() = default;
		explicit CompareIntsInlineNodeDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<CompareIntsInlineNodeDef>;
	};
} // namespace rivet::ddl::generated
