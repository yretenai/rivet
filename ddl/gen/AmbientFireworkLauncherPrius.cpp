...
namespace rivet::ddl::generated {
	AmbientFireworkLauncherPrius::AmbientFireworkLauncherPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		AngleDelta = serialized->get_float(AngleDelta_type_id);
		NumFires = serialized->get_uint32(NumFires_type_id);
		MinFireWait = serialized->get_float(MinFireWait_type_id);
		MaxFireWait = serialized->get_float(MaxFireWait_type_id);
