...
namespace rivet::ddl::generated {
	SaveSettings::SaveSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		NumUsers = serialized->get_int32(NumUsers_type_id, 4u);
		...
		CRCWriterHeapSize = serialized->get_uint32(CRCWriterHeapSize_type_id, 2097152u);
		...
		MaxSnapshotsPerSlot = serialized->get_int32(MaxSnapshotsPerSlot_type_id, 16u);
		MaxSavesPerSlot = serialized->get_int32(MaxSavesPerSlot_type_id, 4u);
		DebugVerbosity = serialized->get_int32(DebugVerbosity_type_id, 0u);
		DebugUI = serialized->get_int32(DebugUI_type_id, 0u);
		...
		MinSaveIconTime = serialized->get_float(MinSaveIconTime_type_id, 3.000000f);
