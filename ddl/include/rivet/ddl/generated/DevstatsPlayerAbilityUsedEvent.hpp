...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsPlayerAbilityUsedEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsPlayerAbilityUsedEvent";
		constexpr static rivet::rivet_type_id type_id = 0x271df9fc;
		...
		constexpr static std::string_view WasInCombat_type_name = "WasInCombat";
		constexpr static rivet::rivet_type_id WasInCombat_type_id = 0x102d9e6a;
		...
		explicit DevstatsPlayerAbilityUsedEvent() = default;
		explicit DevstatsPlayerAbilityUsedEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsPlayerAbilityUsedEvent>;
	};
} // namespace rivet::ddl::generated
