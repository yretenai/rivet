...
public class SoundSwitchGroupDef : DDLObjectType, IDDLObjectType<SoundSwitchGroupDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x4c8c7db8u);

	public SoundSwitchGroupDef(DDLObject ddl) : base(ddl) {
