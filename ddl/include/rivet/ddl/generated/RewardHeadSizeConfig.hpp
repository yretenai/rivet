...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED RewardHeadSizeConfig : ConfigBase {
		...
		std::vector<std::shared_ptr<rivet::ddl::generated::HeadSizeMapping>> HeadSizeMappings {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<RewardHeadSizeConfig>;
	};
} // namespace rivet::ddl::generated
