...
public class ColorGradeOpBaseDef : DDLObjectType, IDDLObjectType<ColorGradeOpBaseDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x357a6009u);

	public ColorGradeOpBaseDef(DDLObject ddl) : base(ddl) {
