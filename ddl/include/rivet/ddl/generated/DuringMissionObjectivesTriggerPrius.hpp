...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED DuringMissionObjectivesTriggerPrius : BaseCustomOverlayTriggerPrius {
		constexpr static std::string_view type_name = "DuringMissionObjectivesTriggerPrius";
		constexpr static rivet::rivet_type_id type_id = 0x8dc9416c;
		...
		explicit DuringMissionObjectivesTriggerPrius() = default;
		explicit DuringMissionObjectivesTriggerPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DuringMissionObjectivesTriggerPrius>;
	};
} // namespace rivet::ddl::generated
