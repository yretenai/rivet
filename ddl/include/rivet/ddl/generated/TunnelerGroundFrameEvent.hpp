...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED TunnelerGroundFrameEvent : EventBase {
		constexpr static std::string_view type_name = "TunnelerGroundFrameEvent";
		constexpr static rivet::rivet_type_id type_id = 0xfb1a9035;
		...
		explicit TunnelerGroundFrameEvent() = default;
		explicit TunnelerGroundFrameEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TunnelerGroundFrameEvent>;
	};
} // namespace rivet::ddl::generated
