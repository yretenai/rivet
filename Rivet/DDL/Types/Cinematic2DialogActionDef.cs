...
public class Cinematic2DialogActionDef : DDLObjectType, IDDLObjectType<Cinematic2DialogActionDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x2a35d2d2u);

	public Cinematic2DialogActionDef(DDLObject ddl) : base(ddl) {
		...
		PerformanceClipPath = ddl.GetValue<RivetAssetId>(0x92c48ff6u, PerformanceClipPath);
		IgnorePhonemes = ddl.GetValue<bool>(0x9b410d6bu, IgnorePhonemes);
