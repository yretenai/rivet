...
namespace rivet::ddl::generated {
	AnimatedSignPrius::AnimatedSignPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		TriggerVolume = serialized->get_uint64(TriggerVolume_type_id, 0ull);
		...
		TriggeringTargets = serialized->get_bitset<rivet::ddl::generated::xd86baa4d>(TriggeringTargets_type_id, rivet::ddl::generated::xd86baa4d_values, 0u); 
	}
