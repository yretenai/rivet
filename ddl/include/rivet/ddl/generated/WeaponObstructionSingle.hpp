...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED WeaponObstructionSingle : WeaponObstructionBase {
		...
		std::shared_ptr<rivet::ddl::generated::BarrelObstructionBase> Weapon {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<WeaponObstructionSingle>;
	};
} // namespace rivet::ddl::generated
