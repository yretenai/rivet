...
namespace rivet::ddl::generated {
	SimpleAmbientSpawnerPrius::SimpleAmbientSpawnerPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		NumToSpawn = serialized->get_float(NumToSpawn_type_id, -1.000000f);
		NumToSpawnImmed = serialized->get_uint8(NumToSpawnImmed_type_id, 0u);
		SpawnTimeMin = serialized->get_float(SpawnTimeMin_type_id, 60.000000f);
		SpawnTimeMax = serialized->get_float(SpawnTimeMax_type_id, 180.000000f);
		UsePlayerForward = serialized->get_bool(UsePlayerForward_type_id, false);
		AngleFromPlayerMin = serialized->get_float(AngleFromPlayerMin_type_id, -60.000000f);
		AngleFromPlayerMax = serialized->get_float(AngleFromPlayerMax_type_id, 60.000000f);
		DistFromPlayerMin = serialized->get_float(DistFromPlayerMin_type_id, 50.000000f);
		DistFromPlayerMax = serialized->get_float(DistFromPlayerMax_type_id, 100.000000f);
