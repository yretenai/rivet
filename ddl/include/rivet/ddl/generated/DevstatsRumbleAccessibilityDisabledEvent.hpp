...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsRumbleAccessibilityDisabledEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsRumbleAccessibilityDisabledEvent";
		constexpr static rivet::rivet_type_id type_id = 0xb2f1aa82;
		...
		explicit DevstatsRumbleAccessibilityDisabledEvent() = default;
		explicit DevstatsRumbleAccessibilityDisabledEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsRumbleAccessibilityDisabledEvent>;
	};
} // namespace rivet::ddl::generated
