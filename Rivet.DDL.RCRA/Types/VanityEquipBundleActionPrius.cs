...
public class VanityEquipBundleActionPrius : DDLObjectType, IDDLObjectType<VanityEquipBundleActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xa7d75eb4u);

	public VanityEquipBundleActionPrius(DDLObject ddl) : base(ddl) {
