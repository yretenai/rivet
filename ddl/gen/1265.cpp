...
namespace rivet::ddl::generated {
	CameraPrius::CameraPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		HorizontalFOV = serialized->get_float(HorizontalFOV_type_id);
		NearClip = serialized->get_float(NearClip_type_id);
		FarClip = serialized->get_float(FarClip_type_id);
		HorizontalLength = serialized->get_float(HorizontalLength_type_id); 
	}

	auto
	CameraPrius::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}
