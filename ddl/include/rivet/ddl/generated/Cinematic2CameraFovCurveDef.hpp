...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2CameraFovCurveDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2CameraFovCurveDef";
		constexpr static rivet::rivet_type_id type_id = 0xe1696826;
		...
		explicit Cinematic2CameraFovCurveDef() = default;
		explicit Cinematic2CameraFovCurveDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2CameraFovCurveDef>;
	};
} // namespace rivet::ddl::generated
