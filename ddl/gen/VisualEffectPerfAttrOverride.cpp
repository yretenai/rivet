...
namespace rivet::ddl::generated {
	...
	[[nodiscard]] auto
	VisualEffectPerfAttrOverride::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	VisualEffectPerfAttrOverride::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectPerfAttrOverride> {
		if (incoming_type_id == VisualEffectPerfAttrOverride::type_id) {
			return std::make_shared<VisualEffectPerfAttrOverride>(serialized);
		}
