...
namespace rivet::ddl::generated {
	MaterialDef::MaterialDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		OverlapType = serialized->get_enum<rivet::ddl::generated::OverlapType>(OverlapType_type_id, rivet::ddl::generated::OverlapType_values, rivet::ddl::generated::OverlapType::Full);
		MotionBlur = serialized->get_enum<rivet::ddl::generated::MotionBlur>(MotionBlur_type_id, rivet::ddl::generated::MotionBlur_values, rivet::ddl::generated::MotionBlur::Opaque_Only);
		...
		CastOpaqueShadow = serialized->get_bool(CastOpaqueShadow_type_id, true);
		SkipEmbeddedTest = serialized->get_bool(SkipEmbeddedTest_type_id, false);
		SkipLightCapture = serialized->get_bool(SkipLightCapture_type_id, false);
		SkipRayTracedShadows = serialized->get_bool(SkipRayTracedShadows_type_id, false);
		UseAoOnDecals = serialized->get_bool(UseAoOnDecals_type_id, false);
		HasAnimatedTexture = serialized->get_bool(HasAnimatedTexture_type_id, false);
