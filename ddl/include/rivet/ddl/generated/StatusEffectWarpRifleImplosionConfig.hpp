...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED StatusEffectWarpRifleImplosionConfig : StatusEffectConfig {
		...
		std::string_view ImplosionConfig {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<StatusEffectWarpRifleImplosionConfig>;
	};
} // namespace rivet::ddl::generated
