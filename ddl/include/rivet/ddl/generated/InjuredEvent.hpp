...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED InjuredEvent : EventBase {
		constexpr static std::string_view type_name = "InjuredEvent";
		constexpr static rivet::rivet_type_id type_id = 0xeb206d36;
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<InjuredEvent>;
	};
} // namespace rivet::ddl::generated
