...
namespace rivet::ddl::generated {
	GameBotPufferFishPrius::GameBotPufferFishPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): GameBotMeleeSwarmerPrius(serialized) {
		SwimVolumes = serialized->get_uint64(SwimVolumes_type_id);
		BreachAnimClues = serialized->get_uint64(BreachAnimClues_type_id);
		EngagedSwimSpeedMult = serialized->get_float(EngagedSwimSpeedMult_type_id); 
	}
