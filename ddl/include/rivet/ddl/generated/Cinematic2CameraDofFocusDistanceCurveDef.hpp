...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2CameraDofFocusDistanceCurveDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2CameraDofFocusDistanceCurveDef";
		constexpr static rivet::rivet_type_id type_id = 0xb4d1f3aa;
		...
		explicit Cinematic2CameraDofFocusDistanceCurveDef() = default;
		explicit Cinematic2CameraDofFocusDistanceCurveDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2CameraDofFocusDistanceCurveDef>;
	};
} // namespace rivet::ddl::generated
