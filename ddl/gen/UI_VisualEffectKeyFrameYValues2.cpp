...
namespace rivet::ddl::generated {
	UI_VisualEffectKeyFrameYValues2::UI_VisualEffectKeyFrameYValues2([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		FloatXA = serialized->get_float(FloatXA_type_id, 0.000000f);
		FloatXB = serialized->get_float(FloatXB_type_id, 0.000000f);
		FloatYA = serialized->get_float(FloatYA_type_id, 0.000000f);
		FloatYB = serialized->get_float(FloatYB_type_id, 0.000000f);
		FloatZA = serialized->get_float(FloatZA_type_id, 0.000000f);
		FloatZB = serialized->get_float(FloatZB_type_id, 0.000000f);
