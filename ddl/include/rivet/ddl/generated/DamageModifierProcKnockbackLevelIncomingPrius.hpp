...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED DamageModifierProcKnockbackLevelIncomingPrius : DamageModifierProcIncomingPrius {
		constexpr const static std::string_view type_name = "DamageModifierProcKnockbackLevelIncomingPrius";
		constexpr const static rivet::rivet_type_id type_id = 0x3839cc4c;
