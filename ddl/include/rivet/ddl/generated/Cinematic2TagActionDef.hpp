...
namespace rivet::ddl::generated {
	struct Cinematic2ActionTagsDef; 

	struct RIVET_DDL_SHARED Cinematic2TagActionDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2TagActionDef";
		constexpr static rivet::rivet_type_id type_id = 0x3ce605a3;
		...
		explicit Cinematic2TagActionDef() = default;
		explicit Cinematic2TagActionDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);

		uint64_t Id {};
		float Time {};
		rivet::ddl::generated::x29c933e2 DurationType {};
		float Duration {};
		std::shared_ptr<rivet::ddl::generated::Cinematic2ActionTagsDef> Tags {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2TagActionDef>;
	};
} // namespace rivet::ddl::generated
