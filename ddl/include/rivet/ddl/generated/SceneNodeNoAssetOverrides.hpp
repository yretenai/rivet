...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED SceneNodeNoAssetOverrides : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "SceneNodeNoAssetOverrides";
		constexpr static rivet::rivet_type_id type_id = 0x7177d09d;
		...
		explicit SceneNodeNoAssetOverrides() = default;
		explicit SceneNodeNoAssetOverrides([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<SceneNodeNoAssetOverrides>;
	};
} // namespace rivet::ddl::generated
