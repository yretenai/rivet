...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED VisualEffectSharedAssetNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectSharedAssetNode";
		constexpr static rivet::rivet_type_id type_id = 0xd91c4a50;
		...
		explicit VisualEffectSharedAssetNode() = default;
		explicit VisualEffectSharedAssetNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectSharedAssetNode>;
	};
} // namespace rivet::ddl::generated
