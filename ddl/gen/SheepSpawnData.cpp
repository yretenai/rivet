...
namespace rivet::ddl::generated {
	SheepSpawnData::SheepSpawnData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): ActorSpawnData(serialized) {
		...
		ShockwaveRingAssetId = serialized->get_uint64(ShockwaveRingAssetId_type_id);
		...
		DamagerHandle = serialized->get_uint32(DamagerHandle_type_id);
		SourceHandle = serialized->get_uint32(SourceHandle_type_id); 
	}
