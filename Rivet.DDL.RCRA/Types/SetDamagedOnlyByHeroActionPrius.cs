...
public class SetDamagedOnlyByHeroActionPrius : DDLObjectType, IDDLObjectType<SetDamagedOnlyByHeroActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x471ae1c3u);

	public SetDamagedOnlyByHeroActionPrius(DDLObject ddl) : base(ddl) {
