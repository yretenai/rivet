...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2ActorTagTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2ActorTagTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xbe38084;
		...
		explicit Cinematic2ActorTagTrackDef() = default;
		explicit Cinematic2ActorTagTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2ActorTagTrackDef>;
	};
} // namespace rivet::ddl::generated
