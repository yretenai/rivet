...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED CompareIntsNodeDef : MathNodeBaseDef {
		constexpr static std::string_view type_name = "CompareIntsNodeDef";
		constexpr static rivet::rivet_type_id type_id = 0x990eb4f4;
		...
		explicit CompareIntsNodeDef() = default;
		explicit CompareIntsNodeDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);

		std::shared_ptr<rivet::ddl::generated::InputPlugSignal> Compare {};
		std::shared_ptr<rivet::ddl::generated::InputPlugInt> A {};
		std::shared_ptr<rivet::ddl::generated::InputPlugInt> B {};
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<CompareIntsNodeDef>;
	};
} // namespace rivet::ddl::generated
