...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2ActorTextureTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2ActorTextureTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x861d20eb;
		...
		explicit Cinematic2ActorTextureTrackDef() = default;
		explicit Cinematic2ActorTextureTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		bool Global {};
		std::vector<std::shared_ptr<rivet::ddl::generated::Cinematic2TextureActionDef>> Actions {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2ActorTextureTrackDef>;
	};
} // namespace rivet::ddl::generated
