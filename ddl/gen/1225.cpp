...
namespace rivet::ddl::generated {
	VehicleCurveGeneratorInfo::VehicleCurveGeneratorInfo([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		MaxPositionHistoryPoints = serialized->get_uint16(MaxPositionHistoryPoints_type_id);
		PositionHistorySegmentLength = serialized->get_float(PositionHistorySegmentLength_type_id);
		MaxBlendPoints = serialized->get_uint16(MaxBlendPoints_type_id);
		BlendSegmentLength = serialized->get_float(BlendSegmentLength_type_id);
		MaxDestinationNodes = serialized->get_uint16(MaxDestinationNodes_type_id);
		CurveRegenMinT = serialized->get_float(CurveRegenMinT_type_id);
		MergeBezierPoints = serialized->get_uint16(MergeBezierPoints_type_id);
		MergeBezierSpeedCoeff = serialized->get_float(MergeBezierSpeedCoeff_type_id);
		MinPostMergeDistance = serialized->get_float(MinPostMergeDistance_type_id);
		BezierMergeDistances = serialized->unwrap_into_many<rivet::ddl::generated::VehicleMergeDistance>(BezierMergeDistances_type_id); 
	}

	auto
	VehicleCurveGeneratorInfo::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}
