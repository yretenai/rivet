...
public class RCSPrintOutput : DDLObjectType, IDDLObjectType<RCSPrintOutput> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x1e74c3d6u);

	public RCSPrintOutput(DDLObject ddl) : base(ddl) {
