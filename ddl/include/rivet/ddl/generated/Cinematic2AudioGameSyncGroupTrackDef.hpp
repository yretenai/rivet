...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2AudioGameSyncGroupTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2AudioGameSyncGroupTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x9007d75e;
		...
		explicit Cinematic2AudioGameSyncGroupTrackDef() = default;
		explicit Cinematic2AudioGameSyncGroupTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2AudioGameSyncGroupTrackDef>;
	};
} // namespace rivet::ddl::generated
