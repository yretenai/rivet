...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED GameFocusTrackingConfig : FocusTrackingConfig {
		...
		std::shared_ptr<rivet::ddl::generated::GameFocusTrackingManagerData> GameFocusTrackingData {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<GameFocusTrackingConfig>;
	};
} // namespace rivet::ddl::generated
