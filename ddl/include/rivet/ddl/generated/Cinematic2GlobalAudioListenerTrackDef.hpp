...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2GlobalAudioListenerTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2GlobalAudioListenerTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x5a5a9790;
		...
		explicit Cinematic2GlobalAudioListenerTrackDef() = default;
		explicit Cinematic2GlobalAudioListenerTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2GlobalAudioListenerTrackDef>;
	};
} // namespace rivet::ddl::generated
