...
public class Cinematic2AudioTrackDef : DDLObjectType, IDDLObjectType<Cinematic2AudioTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xda9e0a9eu);

	public Cinematic2AudioTrackDef(DDLObject ddl) : base(ddl) {
