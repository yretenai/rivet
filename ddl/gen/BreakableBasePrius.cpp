...
namespace rivet::ddl::generated {
	BreakableBasePrius::BreakableBasePrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		MaxHealth = serialized->get_float(MaxHealth_type_id, 100.000000f);
		ManualBreak = serialized->get_bool(ManualBreak_type_id, false);
		ChunkExitVelocity = serialized->get_float(ChunkExitVelocity_type_id, 5.000000f);
		...
		ChunkLifeTimeMin = serialized->get_float(ChunkLifeTimeMin_type_id, 4.000000f);
		ChunkLifeTimeMax = serialized->get_float(ChunkLifeTimeMax_type_id, 8.000000f);
		CullChunksOffscreen = serialized->get_bool(CullChunksOffscreen_type_id, false);
		ChunkCollisionStartDelay = serialized->get_float(ChunkCollisionStartDelay_type_id, 0.000000f);
		...
		DebrisExitVelocity = serialized->get_float(DebrisExitVelocity_type_id, 10.000000f);
		DebrisAngularVel = serialized->get_float(DebrisAngularVel_type_id, 3.000000f);
		...
		DebrisPerChunk = serialized->get_uint32(DebrisPerChunk_type_id, 3u);
		...
		BlendFromHitDirection = serialized->get_float(BlendFromHitDirection_type_id, 0.500000f);
		...
		BreaksAtImpactMomentum = serialized->get_float(BreaksAtImpactMomentum_type_id, 0.000000f);
		...
		AreaDamage = serialized->get_float(AreaDamage_type_id, 0.000000f);
		...
		AreaDamageRadius = serialized->get_float(AreaDamageRadius_type_id, 0.000000f);
		...
		AreaStatusAmount = serialized->get_float(AreaStatusAmount_type_id, 0.000000f);
		...
		StumpLifeTime = serialized->get_float(StumpLifeTime_type_id, 0.000000f);
		...
		DependentDelay = serialized->get_float(DependentDelay_type_id, 0.000000f);
