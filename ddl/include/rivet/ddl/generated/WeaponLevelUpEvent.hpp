...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED WeaponLevelUpEvent : EventBase {
		constexpr static std::string_view type_name = "WeaponLevelUpEvent";
		constexpr static rivet::rivet_type_id type_id = 0xeffc33e1;
		...
		explicit WeaponLevelUpEvent() = default;
		explicit WeaponLevelUpEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<WeaponLevelUpEvent>;
	};
} // namespace rivet::ddl::generated
