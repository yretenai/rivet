...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED TerrainSystem03EditingTerrain0415 : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "TerrainSystem03EditingTerrain0415";
		constexpr static rivet::rivet_type_id type_id = 0x1178143e;
		...
		explicit TerrainSystem03EditingTerrain0415() = default;
		explicit TerrainSystem03EditingTerrain0415([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TerrainSystem03EditingTerrain0415>;
	};
} // namespace rivet::ddl::generated
