...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED FinaleNefWeakspotDamagedStage1Event : EventBase {
		constexpr static std::string_view type_name = "FinaleNefWeakspotDamagedStage1Event";
		constexpr static rivet::rivet_type_id type_id = 0x5ad9d825;
		...
		explicit FinaleNefWeakspotDamagedStage1Event() = default;
		explicit FinaleNefWeakspotDamagedStage1Event([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<FinaleNefWeakspotDamagedStage1Event>;
	};
} // namespace rivet::ddl::generated
