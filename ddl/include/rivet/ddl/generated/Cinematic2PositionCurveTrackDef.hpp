...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2PositionCurveTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2PositionCurveTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x76101ad;
		...
		explicit Cinematic2PositionCurveTrackDef() = default;
		explicit Cinematic2PositionCurveTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2PositionCurveTrackDef>;
	};
} // namespace rivet::ddl::generated
