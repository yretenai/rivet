...
#include <rivet/ddl/generated/UI_MaterialNodeInputPortXYZ.hpp>

namespace rivet::ddl::generated {
	UI_MaterialNodeInputPortXYZ::UI_MaterialNodeInputPortXYZ([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
	...
	[[nodiscard]] auto
	UI_MaterialNodeInputPortXYZ::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortXYZ::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortXYZ> {
		if (incoming_type_id == UI_MaterialNodeInputPortXYZ::type_id) {
			return std::make_shared<UI_MaterialNodeInputPortXYZ>(serialized);
		}
