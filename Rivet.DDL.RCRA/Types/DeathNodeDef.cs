...
[DDLRegistration(0x64fcceffu)]
public class DeathNodeDef : DDLObjectType, IDDLObjectType<DeathNodeDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x64fcceffu);

	public DeathNodeDef(DDLObject ddl) : base(ddl) {
	...
	public static DeathNodeDef Create(DDLObject ddl) => new(ddl);
}
