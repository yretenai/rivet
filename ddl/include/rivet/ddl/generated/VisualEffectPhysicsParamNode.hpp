...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED VisualEffectPhysicsParamNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectPhysicsParamNode";
		constexpr static rivet::rivet_type_id type_id = 0x48c96734;
		...
		explicit VisualEffectPhysicsParamNode() = default;
		explicit VisualEffectPhysicsParamNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::VisualEffectPhysicsParam> OutputPort_Output {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectPhysicsParamNode>;
	};
} // namespace rivet::ddl::generated
