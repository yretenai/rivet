...
[DDLRegistration(0x5e59b70bu)]
public class SceneNodeNoActorOverrides : DDLObjectType, IDDLObjectType<SceneNodeNoActorOverrides> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x5e59b70bu);

	public SceneNodeNoActorOverrides(DDLObject ddl) : base(ddl) {
	...
	[DDLRegistration(0x5e59b70bu, "Transform")]
	...
	[DDLRegistration(0x5e59b70bu, description: "User settable sorting key")]
	public float SortValue { get; set; } = 0.00f;

	[DDLRegistration(0x5e59b70bu, "Type")]
	public AssetExtensions AssetType { get; set; } = AssetExtensions.Actor;

	[DDLRegistration(0x5e59b70bu, "Asset Path")]
	...
	[DDLRegistration(0x5e59b70bu, "Asset Overrides")]
	public string? AssetOverrides { get; set; } = default;

	[DDLRegistration(0x5e59b70bu, "Actor Overrides")]
	public string? ActorOverrides { get; set; } = default;

	public static SceneNodeNoActorOverrides Create(DDLObject ddl) => new(ddl);
}
