...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED NodeGraphPausedDebugMessage : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "NodeGraphPausedDebugMessage";
		constexpr static rivet::rivet_type_id type_id = 0xb0286faa;
		...
		explicit NodeGraphPausedDebugMessage() = default;
		explicit NodeGraphPausedDebugMessage([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<NodeGraphPausedDebugMessage>;
	};
} // namespace rivet::ddl::generated
