...
namespace rivet::ddl::generated {
	HeroLevelConfig::HeroLevelConfig([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): ConfigBase(serialized) {
		ExplosionDelayTime = serialized->get_float(ExplosionDelayTime_type_id, 2.000000f);
		DamageRadius = serialized->get_float(DamageRadius_type_id, 30.000000f);
		BaseDamageAmount = serialized->get_float(BaseDamageAmount_type_id, 100.000000f);
		BonusPerLevelDamage = serialized->get_float(BonusPerLevelDamage_type_id, 25.000000f);
		...
		SlowDownPercent = serialized->get_float(SlowDownPercent_type_id, 1.000000f);
		...
		MaterialFadeOutTime = serialized->get_float(MaterialFadeOutTime_type_id, 1.000000f);
		...
		NormalModeLevelCap = serialized->get_uint32(NormalModeLevelCap_type_id, 0u);
