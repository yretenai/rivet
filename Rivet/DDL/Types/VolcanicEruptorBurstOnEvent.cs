...
public class VolcanicEruptorBurstOnEvent : EventBase, IDDLObjectType<VolcanicEruptorBurstOnEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0xcc71870au);

	public VolcanicEruptorBurstOnEvent(DDLObject ddl) : base(ddl) {
