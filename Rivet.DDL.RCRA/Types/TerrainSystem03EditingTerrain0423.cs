...
[DDLRegistration(0xd336e2c8u)]
public class TerrainSystem03EditingTerrain0423 : DDLObjectType, IDDLObjectType<TerrainSystem03EditingTerrain0423> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xd336e2c8u);

	public TerrainSystem03EditingTerrain0423(DDLObject ddl) : base(ddl) {
