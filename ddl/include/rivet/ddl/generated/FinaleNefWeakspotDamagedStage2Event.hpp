...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED FinaleNefWeakspotDamagedStage2Event : EventBase {
		constexpr static std::string_view type_name = "FinaleNefWeakspotDamagedStage2Event";
		constexpr static rivet::rivet_type_id type_id = 0xdc4daa8b;
		...
		explicit FinaleNefWeakspotDamagedStage2Event() = default;
		explicit FinaleNefWeakspotDamagedStage2Event([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<FinaleNefWeakspotDamagedStage2Event>;
	};
} // namespace rivet::ddl::generated
