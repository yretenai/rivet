...
#include <rivet/ddl/generated/UI_MaterialNodeInputPortChannelMask.hpp>

namespace rivet::ddl::generated {
	UI_MaterialNodeInputPortChannelMask::UI_MaterialNodeInputPortChannelMask([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		ChannelMask = serialized->unwrap_into<rivet::ddl::generated::DDLVector4>(ChannelMask_type_id); 
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortChannelMask::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortChannelMask::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortChannelMask> {
		if (incoming_type_id == UI_MaterialNodeInputPortChannelMask::type_id) {
			return std::make_shared<UI_MaterialNodeInputPortChannelMask>(serialized);
		}
