...
#include <rivet/ddl/generated/SceneNodeNoAssetOverrides.hpp>

namespace rivet::ddl::generated {
	SceneNodeNoAssetOverrides::SceneNodeNoAssetOverrides([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
	...
	[[nodiscard]] auto
	SceneNodeNoAssetOverrides::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	SceneNodeNoAssetOverrides::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<SceneNodeNoAssetOverrides> {
		if (incoming_type_id == SceneNodeNoAssetOverrides::type_id) {
			return std::make_shared<SceneNodeNoAssetOverrides>(serialized);
		}
