...
namespace rivet::ddl::generated {
	ModelSplineDescriptionDef::ModelSplineDescriptionDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		TessAmountMax = serialized->get_uint32(TessAmountMax_type_id, 16u);
		TessAmountMin = serialized->get_uint32(TessAmountMin_type_id, 4u);
		StrandsPerClumpMax = serialized->get_uint32(StrandsPerClumpMax_type_id, 1u);
		StrandsPerClumpMin = serialized->get_uint32(StrandsPerClumpMin_type_id, 1u);
		LodDistance = serialized->get_float(LodDistance_type_id, 10.000000f);
		LodReduction = serialized->get_float(LodReduction_type_id, 8.000000f);
		SkipShadows = serialized->get_bool(SkipShadows_type_id, false);
		StrandLengthRandom = serialized->get_float(StrandLengthRandom_type_id, 0.000000f);
		StrandThickness = serialized->unwrap_into<rivet::ddl::generated::ModelSplineEnvelopeFloatDef>(StrandThickness_type_id);
		StrandThicknessRandom = serialized->get_float(StrandThicknessRandom_type_id, 0.000000f);
		ClumpStrayPower = serialized->get_float(ClumpStrayPower_type_id, 1.000000f);
		ClumpStrayStrength = serialized->get_float(ClumpStrayStrength_type_id, 1.000000f);
		...
		StrandRoundness = serialized->get_float(StrandRoundness_type_id, 1.000000f);
		ClumpRoundness = serialized->get_float(ClumpRoundness_type_id, 1.000000f);
		Gloss = serialized->get_float(Gloss_type_id, 0.800000f);
		...
		SimulationStiffnessLength = serialized->get_float(SimulationStiffnessLength_type_id, 0.050000f);
		SimulationStiffnessPower = serialized->get_float(SimulationStiffnessPower_type_id, 2.000000f);
		SimulationDrag = serialized->get_float(SimulationDrag_type_id, 0.500000f);
		SimulationWindStrength = serialized->get_float(SimulationWindStrength_type_id, 0.000000f);
		SimulationWindTurbulence = serialized->get_float(SimulationWindTurbulence_type_id, 0.000000f); 
	}
