...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED MacroLoadpointData : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "MacroLoadpointData";
		constexpr static rivet::rivet_type_id type_id = 0x82a6774a;
		...
		constexpr static std::string_view LoadpointNameLocTag_type_name = "LoadpointNameLocTag";
		constexpr static rivet::rivet_type_id LoadpointNameLocTag_type_id = 0xc3b90c7f;
