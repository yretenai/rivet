...
namespace rivet::ddl::generated {
	ColorGradeHueSatOpDef::ColorGradeHueSatOpDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		HueInc = serialized->get_float(HueInc_type_id, 0.000000f);
		SaturationInc = serialized->get_float(SaturationInc_type_id, 0.000000f);
		LightnessInc = serialized->get_float(LightnessInc_type_id, 0.000000f); 
	}
