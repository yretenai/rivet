...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2RotationCurveTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2RotationCurveTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xbeca2597;
		...
		explicit Cinematic2RotationCurveTrackDef() = default;
		explicit Cinematic2RotationCurveTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2RotationCurveTrackDef>;
	};
} // namespace rivet::ddl::generated
