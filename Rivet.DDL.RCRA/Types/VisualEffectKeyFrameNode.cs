...
public class VisualEffectKeyFrameNode : DDLObjectType, IDDLObjectType<VisualEffectKeyFrameNode> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x904eb287u);

	public VisualEffectKeyFrameNode(DDLObject ddl) : base(ddl) {
		...
		InputPort_LifeTimeOverride = ddl.GetObject<VisualEffectFloat>(0x65a34ae4u);
