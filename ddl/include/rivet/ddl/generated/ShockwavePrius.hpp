...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ShockwavePrius : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "ShockwavePrius";
		constexpr static rivet::rivet_type_id type_id = 0x818f648e;

		constexpr static std::string_view Damage_type_name = "Damage";
		constexpr static rivet::rivet_type_id Damage_type_id = 0x2fb01a0b;
		constexpr static std::string_view StartRadius_type_name = "StartRadius";
		constexpr static rivet::rivet_type_id StartRadius_type_id = 0x4e61ccda;
		...
		constexpr static std::string_view AllowFriendlyDamage_type_name = "AllowFriendlyDamage";
		constexpr static rivet::rivet_type_id AllowFriendlyDamage_type_id = 0xa63ab0a7;
		...
		constexpr static std::string_view ParentActorHandle_type_name = "ParentActorHandle";
		constexpr static rivet::rivet_type_id ParentActorHandle_type_id = 0xd323fcde;
		constexpr static std::string_view DamageOwnerHandle_type_name = "DamageOwnerHandle";
		constexpr static rivet::rivet_type_id DamageOwnerHandle_type_id = 0x7a09e46d; 
