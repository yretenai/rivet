...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED TargetingAimAngleGamePrius : TargetingAimAnglePrius {
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TargetingAimAngleGamePrius>;
	};
} // namespace rivet::ddl::generated
