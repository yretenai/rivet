...
[DDLRegistration(0x410e924eu)]
public class Cinematic2GlobalOrphanTrackDef : DDLObjectType, IDDLObjectType<Cinematic2GlobalOrphanTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x410e924eu);

	public Cinematic2GlobalOrphanTrackDef(DDLObject ddl) : base(ddl) {
	...
	[DDLRegistration(0x410e924eu, description: "Track will only run on the defined platform(s)")]
	public xb52df7e7 PlatformFilter { get; set; } = (xb52df7e7) 0x00000007;

	[DDLRegistration(0x410e924eu, description: "A set of gameplay-defined values to determine if this track should be processed.")]
	public Cinematic2TrackTagsDef? Tags { get; set; } = default;

	[DDLRegistration(0x410e924eu, description: "If set to true, actions on this track will not move when shots are reordered.")]
	...
	public static Cinematic2GlobalOrphanTrackDef Create(DDLObject ddl) => new(ddl);
}
