...
[DDLRegistration(0x22c0208eu)]
public class Cinematic2LocatorAudioTrackDef : DDLObjectType, IDDLObjectType<Cinematic2LocatorAudioTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x22c0208eu);

	public Cinematic2LocatorAudioTrackDef(DDLObject ddl) : base(ddl) {
	...
	[DDLRegistration(0x22c0208eu, description: "Track will only run on the defined platform(s)")]
	public xb52df7e7 PlatformFilter { get; set; } = (xb52df7e7) 0x00000007;

	[DDLRegistration(0x22c0208eu, description: "A set of gameplay-defined values to determine if this track should be processed.")]
	public Cinematic2TrackTagsDef? Tags { get; set; } = default;

	[DDLRegistration(0x22c0208eu, description: "If set to true, actions on this track will not move when shots are reordered.")]
	...
	public static Cinematic2LocatorAudioTrackDef Create(DDLObject ddl) => new(ddl);
}
