...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED VisualEffectPerfAttrOverrideNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectPerfAttrOverrideNode";
		constexpr static rivet::rivet_type_id type_id = 0xfabd1c9e;
		...
		explicit VisualEffectPerfAttrOverrideNode() = default;
		explicit VisualEffectPerfAttrOverrideNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::VisualEffectPerfAttrOverride> OutputPort_Output {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectPerfAttrOverrideNode>;
	};
} // namespace rivet::ddl::generated
