...
public class CommandGoToActionPrius : DDLObjectType, IDDLObjectType<CommandGoToActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xf898ae29u);

	public CommandGoToActionPrius(DDLObject ddl) : base(ddl) {
