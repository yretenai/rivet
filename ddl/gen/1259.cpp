...
namespace rivet::ddl::generated {
	StickerModeData::StickerModeData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		StickerSpeed = serialized->get_float(StickerSpeed_type_id);
		RotationSpeed = serialized->get_float(RotationSpeed_type_id);
		StickerSpeed4k = serialized->get_float(StickerSpeed4k_type_id);
		ScaleRate = serialized->get_float(ScaleRate_type_id);
		ScaleRate4k = serialized->get_float(ScaleRate4k_type_id);
	...
	auto
	StickerModeData::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}
