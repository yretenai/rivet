...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2CameraMagnitudeCurveTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2CameraMagnitudeCurveTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x32d114e9;
		...
		explicit Cinematic2CameraMagnitudeCurveTrackDef() = default;
		explicit Cinematic2CameraMagnitudeCurveTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2CameraMagnitudeCurveTrackDef>;
	};
} // namespace rivet::ddl::generated
