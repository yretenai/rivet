...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ToggleLookNodeDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "ToggleLookNodeDef";
		constexpr static rivet::rivet_type_id type_id = 0x80b9fd1e;
		...
		explicit ToggleLookNodeDef() = default;
		explicit ToggleLookNodeDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ToggleLookNodeDef>;
	};
} // namespace rivet::ddl::generated
