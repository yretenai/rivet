...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2LightAttachTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2LightAttachTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xcb5aa415;
		...
		explicit Cinematic2LightAttachTrackDef() = default;
		explicit Cinematic2LightAttachTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		bool Global {};
		std::vector<std::shared_ptr<rivet::ddl::generated::Cinematic2LightAttachActionDef>> Actions {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2LightAttachTrackDef>;
	};
} // namespace rivet::ddl::generated
