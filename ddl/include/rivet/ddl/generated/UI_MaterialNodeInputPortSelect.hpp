...
namespace rivet::ddl::generated {
	struct UI_MaterialNodeSelect; 

	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortSelect : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortSelect";
		constexpr static rivet::rivet_type_id type_id = 0x2ac19a4d;
		...
		explicit UI_MaterialNodeInputPortSelect() = default;
		explicit UI_MaterialNodeInputPortSelect([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		bool ShowExposed {};
		bool ShowGlobal {};
		std::shared_ptr<rivet::ddl::generated::UI_MaterialNodeSelect> Select {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortSelect>;
	};
} // namespace rivet::ddl::generated
