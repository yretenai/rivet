...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED RCSFilesOutput : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "RCSFilesOutput";
		constexpr static rivet::rivet_type_id type_id = 0x5523d0d6;
		...
		explicit RCSFilesOutput() = default;
		explicit RCSFilesOutput([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<RCSFilesOutput>;
	};
} // namespace rivet::ddl::generated
