...
public class ProjectileLockedOnEvent : EventBase, IDDLObjectType<ProjectileLockedOnEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0x1c478ddcu);

	public ProjectileLockedOnEvent(DDLObject ddl) : base(ddl) {
