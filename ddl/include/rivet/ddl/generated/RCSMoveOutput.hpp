...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED RCSMoveOutput : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "RCSMoveOutput";
		constexpr static rivet::rivet_type_id type_id = 0x6d9b3ac6;
		...
		explicit RCSMoveOutput() = default;
		explicit RCSMoveOutput([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<RCSMoveOutput>;
	};
} // namespace rivet::ddl::generated
