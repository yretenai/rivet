...
[DDLRegistration(0x80b9fd1eu)]
public class ToggleLookNodeDef : DDLObjectType, IDDLObjectType<ToggleLookNodeDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x80b9fd1eu);

	public ToggleLookNodeDef(DDLObject ddl) : base(ddl) {
	...
	public static ToggleLookNodeDef Create(DDLObject ddl) => new(ddl);
}
