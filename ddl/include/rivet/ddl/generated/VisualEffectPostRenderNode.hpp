...
#include <rivet/ddl/generated/enums/x9a2e0494.hpp> 

namespace rivet::ddl::generated {
	struct VisualEffectNodeConnectedOutputPort;
	struct VisualEffectNodeConnectedInputPort; 

	struct RIVET_DDL_SHARED VisualEffectPostRenderNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectPostRenderNode";
		constexpr static rivet::rivet_type_id type_id = 0xe94a3ecc;
		...
		constexpr static std::string_view RenderType_type_name = "RenderType";
		constexpr static rivet::rivet_type_id RenderType_type_id = 0xb0ef7733;
		...
		explicit VisualEffectPostRenderNode() = default;
		explicit VisualEffectPostRenderNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		rivet::ddl::generated::x9a2e0494 RenderType {};
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectPostRenderNode>;
	};
} // namespace rivet::ddl::generated
