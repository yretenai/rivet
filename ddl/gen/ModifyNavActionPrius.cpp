...
namespace rivet::ddl::generated {
	ModifyNavActionPrius::ModifyNavActionPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		MeshTemplate = serialized->get_uint32(MeshTemplate_type_id, 0u);
		PolyFlags = serialized->get_bitset<rivet::ddl::generated::xc204b456>(PolyFlags_type_id, rivet::ddl::generated::xc204b456_values, 1u); 
	}
