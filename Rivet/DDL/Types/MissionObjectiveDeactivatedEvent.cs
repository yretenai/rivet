...
public class MissionObjectiveDeactivatedEvent : EventBase, IDDLObjectType<MissionObjectiveDeactivatedEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0x35d6494au);

	public MissionObjectiveDeactivatedEvent(DDLObject ddl) : base(ddl) {
