...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED VisualEffectMinMaxNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectMinMaxNode";
		constexpr static rivet::rivet_type_id type_id = 0x3cbbe2d8;
		...
		explicit VisualEffectMinMaxNode() = default;
		explicit VisualEffectMinMaxNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::VisualEffectMinMax> OutputPort_Output {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectMinMaxNode>;
	};
} // namespace rivet::ddl::generated
