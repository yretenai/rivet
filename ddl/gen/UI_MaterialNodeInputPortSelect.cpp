...
#include <rivet/ddl/generated/UI_MaterialNodeInputPortSelect.hpp>

namespace rivet::ddl::generated {
	UI_MaterialNodeInputPortSelect::UI_MaterialNodeInputPortSelect([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		Select = serialized->unwrap_into<rivet::ddl::generated::UI_MaterialNodeSelect>(Select_type_id); 
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortSelect::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortSelect::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortSelect> {
		if (incoming_type_id == UI_MaterialNodeInputPortSelect::type_id) {
			return std::make_shared<UI_MaterialNodeInputPortSelect>(serialized);
		}
