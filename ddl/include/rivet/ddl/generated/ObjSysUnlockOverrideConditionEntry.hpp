...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ObjSysUnlockOverrideConditionEntry : rivet::structures::rivet_ddl_base {
		...
		std::shared_ptr<rivet::ddl::generated::ObjSysUnlockOverrideConditionBase> Condition {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ObjSysUnlockOverrideConditionEntry>;
	};
} // namespace rivet::ddl::generated
