...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED CommonLootData : rivet::structures::rivet_ddl_base {
		...
		std::string_view LootSetupConfig {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<CommonLootData>;
	};
} // namespace rivet::ddl::generated
