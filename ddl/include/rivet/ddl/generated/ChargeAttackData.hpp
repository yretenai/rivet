...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ChargeAttackData : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "ChargeAttackData";
		constexpr static rivet::rivet_type_id type_id = 0x1355867c;
		...
		constexpr static std::string_view TurnRate_type_name = "TurnRate";
		constexpr static rivet::rivet_type_id TurnRate_type_id = 0x371b2802;
		constexpr static std::string_view TurnRateTell_type_name = "TurnRateTell";
		constexpr static rivet::rivet_type_id TurnRateTell_type_id = 0xae329a0;
		constexpr static std::string_view MinDistToTurn_type_name = "MinDistToTurn";
		constexpr static rivet::rivet_type_id MinDistToTurn_type_id = 0xbec9c8e6;
		...
		constexpr static std::string_view RunPastDistance_type_name = "RunPastDistance";
		constexpr static rivet::rivet_type_id RunPastDistance_type_id = 0x7ded2b99;
		constexpr static std::string_view StunDuration_type_name = "StunDuration";
		constexpr static rivet::rivet_type_id StunDuration_type_id = 0x3bbea58f;
		constexpr static std::string_view HitDuration_type_name = "HitDuration";
		constexpr static rivet::rivet_type_id HitDuration_type_id = 0x96fa17d6;
		constexpr static std::string_view MissDuration_type_name = "MissDuration";
		constexpr static rivet::rivet_type_id MissDuration_type_id = 0xeb64c7c0;
		constexpr static std::string_view TargetLeftOffset_type_name = "TargetLeftOffset";
		constexpr static rivet::rivet_type_id TargetLeftOffset_type_id = 0xa81f5003;
		...
		constexpr static std::string_view TriggerHitOutroOnClose_type_name = "TriggerHitOutroOnClose";
		constexpr static rivet::rivet_type_id TriggerHitOutroOnClose_type_id = 0xfbb2197c;
		constexpr static std::string_view AlsoDamageInHitOutro_type_name = "AlsoDamageInHitOutro";
		constexpr static rivet::rivet_type_id AlsoDamageInHitOutro_type_id = 0x7c341799;
		constexpr static std::string_view PreventDeflection_type_name = "PreventDeflection";
		constexpr static rivet::rivet_type_id PreventDeflection_type_id = 0xf542fb78;
		constexpr static std::string_view TellDriver_type_name = "TellDriver";
		constexpr static rivet::rivet_type_id TellDriver_type_id = 0xbdb09c6f;
		...
		constexpr static std::string_view StunOutroDriver_type_name = "StunOutroDriver";
		constexpr static rivet::rivet_type_id StunOutroDriver_type_id = 0x9a7e6ce1;
		constexpr static std::string_view StunCompressPartial_type_name = "StunCompressPartial";
		constexpr static rivet::rivet_type_id StunCompressPartial_type_id = 0x33096146;
