...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED POILibraryEntry : rivet::structures::rivet_ddl_base {
		...
		rivet::ddl::generated::xfcb30197 POIType {};
		std::shared_ptr<rivet::ddl::generated::POIConfigData> POIConfigData {};
		std::shared_ptr<rivet::ddl::generated::POIPriusBase> POIPriusType {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<POILibraryEntry>;
	};
} // namespace rivet::ddl::generated
