...
namespace rivet::ddl::generated {
	ChangeLogResult::ChangeLogResult([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		ChangeType = serialized->get_enum<rivet::ddl::generated::ChangeType>(ChangeType_type_id, rivet::ddl::generated::ChangeType_values, rivet::ddl::generated::ChangeType::Other);
		MergeJson = serialized->get_field(MergeJson_type_id); 
	}

	[[nodiscard]] auto
	ChangeLogResult::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	ChangeLogResult::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ChangeLogResult> {
		if (incoming_type_id == ChangeLogResult::type_id) {
			return std::make_shared<ChangeLogResult>(serialized);
		}
