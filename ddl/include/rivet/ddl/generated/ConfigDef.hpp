...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ConfigDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "ConfigDef";
		constexpr static rivet::rivet_type_id type_id = 0xf4eefb3e;
		...
		explicit ConfigDef() = default;
		explicit ConfigDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ConfigDef>;
	};
} // namespace rivet::ddl::generated
