...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortChannelMask : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortChannelMask";
		constexpr static rivet::rivet_type_id type_id = 0x713380bd;
		...
		constexpr static std::string_view ChannelMask_type_name = "ChannelMask";
		constexpr static rivet::rivet_type_id ChannelMask_type_id = 0x424ff3eb; 

		explicit UI_MaterialNodeInputPortChannelMask() = default;
		explicit UI_MaterialNodeInputPortChannelMask([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		bool ShowExposed {};
		bool ShowGlobal {};
		std::shared_ptr<rivet::ddl::generated::DDLVector4> ChannelMask {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortChannelMask>;
	};
} // namespace rivet::ddl::generated
