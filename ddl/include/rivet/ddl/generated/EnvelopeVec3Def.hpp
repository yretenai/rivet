...
namespace rivet::ddl::generated {
	struct EnvelopePointVec3; 

	struct RIVET_DDL_SHARED EnvelopeVec3Def : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "EnvelopeVec3Def";
		constexpr static rivet::rivet_type_id type_id = 0xb5551ac7;
		...
		explicit EnvelopeVec3Def() = default;
		explicit EnvelopeVec3Def([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::vector<std::shared_ptr<rivet::ddl::generated::EnvelopePointVec3>> Points {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<EnvelopeVec3Def>;
	};
} // namespace rivet::ddl::generated
