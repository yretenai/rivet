...
public class GrindOnEvent : EventBase, IDDLObjectType<GrindOnEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0x13ddf293u);

	public GrindOnEvent(DDLObject ddl) : base(ddl) {
