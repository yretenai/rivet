...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED Cinematic2BlinkActionDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2BlinkActionDef";
		constexpr static rivet::rivet_type_id type_id = 0xa8a6e9d0;
		...
		explicit Cinematic2BlinkActionDef() = default;
		explicit Cinematic2BlinkActionDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2BlinkActionDef>;
	};
} // namespace rivet::ddl::generated
