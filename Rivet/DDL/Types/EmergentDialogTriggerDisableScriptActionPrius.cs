...
public class EmergentDialogTriggerDisableScriptActionPrius : DDLObjectType, IDDLObjectType<EmergentDialogTriggerDisableScriptActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x83e0b957u);

	public EmergentDialogTriggerDisableScriptActionPrius(DDLObject ddl) : base(ddl) {
