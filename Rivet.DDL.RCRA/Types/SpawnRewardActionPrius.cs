...
public class SpawnRewardActionPrius : DDLObjectType, IDDLObjectType<SpawnRewardActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x7a375667u);

	public SpawnRewardActionPrius(DDLObject ddl) : base(ddl) {
