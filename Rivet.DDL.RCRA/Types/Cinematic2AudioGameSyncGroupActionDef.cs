...
public class Cinematic2AudioGameSyncGroupActionDef : DDLObjectType, IDDLObjectType<Cinematic2AudioGameSyncGroupActionDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xc2048f43u);

	public Cinematic2AudioGameSyncGroupActionDef(DDLObject ddl) : base(ddl) {
