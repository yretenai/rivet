...
namespace rivet::ddl::generated {
	RtEnvProbeSettings::RtEnvProbeSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		CsmLodCount = serialized->get_int32(CsmLodCount_type_id, 0u);
		CsmDrawDistance = serialized->get_float(CsmDrawDistance_type_id, 750.000000f);
		DefaultProbeIntensity = serialized->get_float(DefaultProbeIntensity_type_id, 0.250000f);
		FarClip = serialized->get_float(FarClip_type_id, 2048.000000f);
		...
		LightSourceNightIntensityScale = serialized->get_float(LightSourceNightIntensityScale_type_id, 1.000000f);
		LightSourceNightRadiusScale = serialized->get_float(LightSourceNightRadiusScale_type_id, 1.000000f); 
	}
