...
namespace rivet::ddl::generated {
	TriggerResponderChangeMaterialPrius::TriggerResponderChangeMaterialPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): TriggerResponderBasePrius(serialized) {
		MatConstValueTrig = serialized->get_float(MatConstValueTrig_type_id, 1.000000f);
		MatConstValueNotTrig = serialized->get_float(MatConstValueNotTrig_type_id, 0.000000f);
		MatConstValueDisabled = serialized->get_float(MatConstValueDisabled_type_id, 0.000000f);
		BlendTimeTriggered = serialized->get_float(BlendTimeTriggered_type_id, 0.000000f);
		BlendTimeNotTriggered = serialized->get_float(BlendTimeNotTriggered_type_id, 0.000000f);
		BlendTimeDisabled = serialized->get_float(BlendTimeDisabled_type_id, 0.000000f); 
	}
