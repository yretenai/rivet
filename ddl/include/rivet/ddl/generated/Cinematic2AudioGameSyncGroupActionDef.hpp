...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED Cinematic2AudioGameSyncGroupActionDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2AudioGameSyncGroupActionDef";
		constexpr static rivet::rivet_type_id type_id = 0xc2048f43;
		...
		explicit Cinematic2AudioGameSyncGroupActionDef() = default;
		explicit Cinematic2AudioGameSyncGroupActionDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2AudioGameSyncGroupActionDef>;
	};
} // namespace rivet::ddl::generated
