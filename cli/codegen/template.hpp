...
namespace rivet::ddl::generated {
	constexpr const static inline std::string_view %enum_name%_type_name = "%enum_name%";
...
inline constexpr std::string_view template_struct_type_id = R"(		constexpr const static std::string_view %name%_type_name = "%name%";
