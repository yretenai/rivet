...
namespace rivet::ddl::generated {
	HeroFreezeManagerPrius::HeroFreezeManagerPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		MaxFreezePoints = serialized->get_float(MaxFreezePoints_type_id);
		FreezeLevel1Threshold = serialized->get_float(FreezeLevel1Threshold_type_id);
		FreezeLevel2Threshold = serialized->get_float(FreezeLevel2Threshold_type_id);
		FreezeDeathTime = serialized->get_float(FreezeDeathTime_type_id);
		FreezeDecayRate = serialized->get_float(FreezeDecayRate_type_id);
		FreezeHitAmount = serialized->get_float(FreezeHitAmount_type_id);
		ReFreezeLockoutTime = serialized->get_float(ReFreezeLockoutTime_type_id);
		Flags = serialized->get_bitset<rivet::ddl::generated::x3ebe0bf2>(Flags_type_id, rivet::ddl::generated::x3ebe0bf2_values); 
	}
