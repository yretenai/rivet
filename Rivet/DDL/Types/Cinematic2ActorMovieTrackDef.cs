...
public class Cinematic2ActorMovieTrackDef : DDLObjectType, IDDLObjectType<Cinematic2ActorMovieTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xeb9333b8u);

	public Cinematic2ActorMovieTrackDef(DDLObject ddl) : base(ddl) {
