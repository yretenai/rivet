...
public class Cinematic2ActorLooksTrackDef : DDLObjectType, IDDLObjectType<Cinematic2ActorLooksTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x3891fbb5u);

	public Cinematic2ActorLooksTrackDef(DDLObject ddl) : base(ddl) {
