...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UIOptionTypeSettingSlider : UIOptionTypeSettingBase {
		...
		int32_t SliderMinimum {};
		int32_t SliderFidelity {};
		bool GamePreview {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UIOptionTypeSettingSlider>;
	};
} // namespace rivet::ddl::generated
