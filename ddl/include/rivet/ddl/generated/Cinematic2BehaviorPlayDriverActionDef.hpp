...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED Cinematic2BehaviorPlayDriverActionDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2BehaviorPlayDriverActionDef";
		constexpr static rivet::rivet_type_id type_id = 0x78fe5b10;
		...
		explicit Cinematic2BehaviorPlayDriverActionDef() = default;
		explicit Cinematic2BehaviorPlayDriverActionDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2BehaviorPlayDriverActionDef>;
	};
} // namespace rivet::ddl::generated
