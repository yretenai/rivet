...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortX : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortX";
		constexpr static rivet::rivet_type_id type_id = 0x49dd4df7;
		...
		explicit UI_MaterialNodeInputPortX() = default;
		explicit UI_MaterialNodeInputPortX([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortX>;
	};
} // namespace rivet::ddl::generated
