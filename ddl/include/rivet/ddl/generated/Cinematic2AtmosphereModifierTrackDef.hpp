...
#include <rivet/ddl/generated/enums/xae014f93.hpp>
...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2AtmosphereModifierTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2AtmosphereModifierTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x8c9212bb;
		...
		explicit Cinematic2AtmosphereModifierTrackDef() = default;
		explicit Cinematic2AtmosphereModifierTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		rivet::ddl::generated::xae014f93 Param {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2AtmosphereModifierTrackDef>;
	};
} // namespace rivet::ddl::generated
