...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2ActorDialogGroupTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2ActorDialogGroupTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xf614c0fb;
		...
		explicit Cinematic2ActorDialogGroupTrackDef() = default;
		explicit Cinematic2ActorDialogGroupTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2ActorDialogGroupTrackDef>;
	};
} // namespace rivet::ddl::generated
