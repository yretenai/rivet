...
public class NotMissionSystemNodeDef : MissionSystemNodeBaseDef, IDDLObjectType<NotMissionSystemNodeDef> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0x18dc33fau);

	public NotMissionSystemNodeDef(DDLObject ddl) : base(ddl) {
