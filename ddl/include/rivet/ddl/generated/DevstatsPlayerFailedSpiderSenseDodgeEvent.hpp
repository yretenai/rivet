...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsPlayerFailedSpiderSenseDodgeEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsPlayerFailedSpiderSenseDodgeEvent";
		constexpr static rivet::rivet_type_id type_id = 0xa1f0f8a4;
		...
		explicit DevstatsPlayerFailedSpiderSenseDodgeEvent() = default;
		explicit DevstatsPlayerFailedSpiderSenseDodgeEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsPlayerFailedSpiderSenseDodgeEvent>;
	};
} // namespace rivet::ddl::generated
