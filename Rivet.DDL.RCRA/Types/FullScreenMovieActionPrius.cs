...
public class FullScreenMovieActionPrius : DDLObjectType, IDDLObjectType<FullScreenMovieActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x10f57890u);

	public FullScreenMovieActionPrius(DDLObject ddl) : base(ddl) {
