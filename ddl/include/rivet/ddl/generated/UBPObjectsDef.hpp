...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UBPObjectsDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UBPObjectsDef";
		constexpr static rivet::rivet_type_id type_id = 0x86c1ffef;
		...
		explicit UBPObjectsDef() = default;
		explicit UBPObjectsDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);

		std::string_view schemaVersion {};
		rivet::ddl::generated::xe07d4302 contextType {};
		std::string_view contextId {};
		std::optional<std::vector<rivet::structures::rivet_serialized_value>> entities {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UBPObjectsDef>;
	};
} // namespace rivet::ddl::generated
