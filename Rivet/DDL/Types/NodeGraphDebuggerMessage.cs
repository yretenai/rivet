...
public class NodeGraphDebuggerMessage : DDLObjectType, IDDLObjectType<NodeGraphDebuggerMessage> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x5aacdb0au);
