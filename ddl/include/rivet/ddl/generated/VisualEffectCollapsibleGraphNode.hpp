...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED VisualEffectCollapsibleGraphNode : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "VisualEffectCollapsibleGraphNode";
		constexpr static rivet::rivet_type_id type_id = 0x9b7cd4f5;
		...
		explicit VisualEffectCollapsibleGraphNode() = default;
		explicit VisualEffectCollapsibleGraphNode([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<VisualEffectCollapsibleGraphNode>;
	};
} // namespace rivet::ddl::generated
