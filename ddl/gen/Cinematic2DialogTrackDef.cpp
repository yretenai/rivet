...
namespace rivet::ddl::generated {
	Cinematic2DialogTrackDef::Cinematic2DialogTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		VarHeadHorizontal = serialized->get_string(VarHeadHorizontal_type_id, "Head_Aim_Horizontal");
		VarHeadVertical = serialized->get_string(VarHeadVertical_type_id, "Head_Aim_Vertical");
		VarEyeHorizontal = serialized->get_string(VarEyeHorizontal_type_id, "Eye_Horizontal");
		VarEyeVertical = serialized->get_string(VarEyeVertical_type_id, "Eye_Vertical");
		VarBlink = serialized->get_string(VarBlink_type_id, "Blink");
		LookAtUnits = serialized->get_enum<rivet::ddl::generated::x96e13489>(LookAtUnits_type_id, rivet::ddl::generated::x96e13489_values, rivet::ddl::generated::x96e13489::Degrees);
