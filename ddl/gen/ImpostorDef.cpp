...
#include <rivet/ddl/generated/ImpostorDef.hpp>

namespace rivet::ddl::generated {
	ImpostorDef::ImpostorDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
	...
	[[nodiscard]] auto
	ImpostorDef::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	ImpostorDef::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ImpostorDef> {
		if (incoming_type_id == ImpostorDef::type_id) {
			return std::make_shared<ImpostorDef>(serialized);
		}
