...
[DDLRegistration(0x7177d09du)]
public class SceneNodeNoAssetOverrides : DDLObjectType, IDDLObjectType<SceneNodeNoAssetOverrides> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x7177d09du);

	public SceneNodeNoAssetOverrides(DDLObject ddl) : base(ddl) {
	...
	[DDLRegistration(0x7177d09du, "Transform")]
	...
	[DDLRegistration(0x7177d09du, description: "User settable sorting key")]
	public float SortValue { get; set; } = 0.00f;

	[DDLRegistration(0x7177d09du, "Type")]
	public AssetExtensions AssetType { get; set; } = AssetExtensions.Actor;

	[DDLRegistration(0x7177d09du, "Asset Path")]
	...
	[DDLRegistration(0x7177d09du, "Asset Overrides")]
	public string? AssetOverrides { get; set; } = default;

	[DDLRegistration(0x7177d09du, "Actor Overrides")]
	public string? ActorOverrides { get; set; } = default;

	public static SceneNodeNoAssetOverrides Create(DDLObject ddl) => new(ddl);
}
