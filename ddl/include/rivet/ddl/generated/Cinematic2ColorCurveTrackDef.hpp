...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2ColorCurveTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2ColorCurveTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x94de3171;
		...
		explicit Cinematic2ColorCurveTrackDef() = default;
		explicit Cinematic2ColorCurveTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2ColorCurveTrackDef>;
	};
} // namespace rivet::ddl::generated
