...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED RCSSyncOutput : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "RCSSyncOutput";
		constexpr static rivet::rivet_type_id type_id = 0x47a8afc2;
		...
		explicit RCSSyncOutput() = default;
		explicit RCSSyncOutput([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<RCSSyncOutput>;
	};
} // namespace rivet::ddl::generated
