...
namespace rivet::ddl::generated {
	NetSettings::NetSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		PingPort = serialized->get_uint16(PingPort_type_id, 0u);
		PingPortExternal = serialized->get_uint16(PingPortExternal_type_id, 0u);
		RoomListRequestPort = serialized->get_uint16(RoomListRequestPort_type_id, 0u);
		RoomListResponsePort = serialized->get_uint16(RoomListResponsePort_type_id, 0u);
		...
		TitleId = serialized->get_uint64(TitleId_type_id, 0ull);
		VersionId = serialized->get_uint32(VersionId_type_id, 0u);
		LocalAddress = serialized->get_uint32(LocalAddress_type_id, 0u);
