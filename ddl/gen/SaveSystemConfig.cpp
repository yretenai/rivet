...
namespace rivet::ddl::generated {
	SaveSystemConfig::SaveSystemConfig([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): ConfigBase(serialized) {
		GoldenPathCategoryWeight = serialized->get_float(GoldenPathCategoryWeight_type_id, 60.000000f);
		OptionalMissionCategoryWeight = serialized->get_float(OptionalMissionCategoryWeight_type_id, 25.000000f);
		CollectiblesCategoryWeight = serialized->get_float(CollectiblesCategoryWeight_type_id, 15.000000f);
