...
namespace rivet::ddl::generated {
	GrindHazardPrius::GrindHazardPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		StartTValue = serialized->get_float(StartTValue_type_id, 0.000000f);
		EndTValue = serialized->get_float(EndTValue_type_id, 1.000000f);
		...
		DamagePercent = serialized->get_float(DamagePercent_type_id, 0.100000f);
		DamageRadius = serialized->get_float(DamageRadius_type_id, 0.200000f);
		IgnoreDuration = serialized->get_float(IgnoreDuration_type_id, 0.100000f);
		...
		HazardSpacing = serialized->get_float(HazardSpacing_type_id, 2.000000f);
		HazardStretchPercent = serialized->get_float(HazardStretchPercent_type_id, 0.200000f); 
	}
