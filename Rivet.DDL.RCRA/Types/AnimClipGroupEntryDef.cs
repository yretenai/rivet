...
public class AnimClipGroupEntryDef : DDLObjectType, IDDLObjectType<AnimClipGroupEntryDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xa2d344d5u);

	public AnimClipGroupEntryDef(DDLObject ddl) : base(ddl) {
