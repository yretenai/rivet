...
namespace rivet::ddl::generated {
	Prims::Prims([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		F32 = serialized->get_float(F32_type_id);
		F64 = serialized->get_double(F64_type_id);
		I8 = serialized->get_int8(I8_type_id);
		I16 = serialized->get_int16(I16_type_id);
		I32 = serialized->get_int32(I32_type_id);
		I64 = serialized->get_int64(I64_type_id);
		U8 = serialized->get_uint8(U8_type_id);
		U16 = serialized->get_uint16(U16_type_id);
		U32 = serialized->get_uint32(U32_type_id);
		U64 = serialized->get_uint64(U64_type_id); 
	}
