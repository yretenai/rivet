...
namespace rivet::ddl::generated {
	BossAttackVolumePrius::BossAttackVolumePrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		CooldownMin = serialized->get_float(CooldownMin_type_id, 0.000000f);
		CooldownMax = serialized->get_float(CooldownMax_type_id, 0.000000f);
		ApplyCooldownToTheseVolumes = serialized->get_uint64s(ApplyCooldownToTheseVolumes_type_id);
		GlobalCooldownMin = serialized->get_float(GlobalCooldownMin_type_id, 0.000000f);
		GlobalCooldownMax = serialized->get_float(GlobalCooldownMax_type_id, 0.000000f);
		InitialCooldownMin = serialized->get_float(InitialCooldownMin_type_id, 0.000000f);
		InitialCooldownMax = serialized->get_float(InitialCooldownMax_type_id, 0.000000f);
		OtherCooldownMin = serialized->get_float(OtherCooldownMin_type_id, 0.000000f);
		OtherCooldownMax = serialized->get_float(OtherCooldownMax_type_id, 0.000000f);
		...
		MaxConsecutiveUses = serialized->get_uint32(MaxConsecutiveUses_type_id, 1u);
		...
		GotoAttackPosActor = serialized->get_uint64(GotoAttackPosActor_type_id, 0ull);
