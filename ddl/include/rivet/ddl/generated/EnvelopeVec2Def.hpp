...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED EnvelopeVec2Def : rivet::structures::rivet_ddl_base {
		...
		std::vector<std::shared_ptr<rivet::ddl::generated::EnvelopePointVec2>> Points {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<EnvelopeVec2Def>;
	};
} // namespace rivet::ddl::generated
