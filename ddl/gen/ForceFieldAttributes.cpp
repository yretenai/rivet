...
namespace rivet::ddl::generated {
	ForceFieldAttributes::ForceFieldAttributes([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		SurfaceVelocityOverride = serialized->get_float(SurfaceVelocityOverride_type_id, 0.000000f);
		CenterVelocityOverride = serialized->get_float(CenterVelocityOverride_type_id, 0.000000f);
		SurfaceStrengthScale = serialized->get_float(SurfaceStrengthScale_type_id, 1.000000f);
		CenterStrengthScale = serialized->get_float(CenterStrengthScale_type_id, 1.000000f);
		SurfaceLifeScale = serialized->get_float(SurfaceLifeScale_type_id, 1.000000f);
		CenterLifeScale = serialized->get_float(CenterLifeScale_type_id, 1.000000f);
		CenterBias = serialized->get_float(CenterBias_type_id, 0.000000f);
		Density = serialized->get_float(Density_type_id, 2.000000f);
