...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED EmergentVOConfig : ConfigBase {
		...
		std::vector<std::shared_ptr<rivet::ddl::generated::DialogRuleArray>> RuleArray {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<EmergentVOConfig>;
	};
} // namespace rivet::ddl::generated
