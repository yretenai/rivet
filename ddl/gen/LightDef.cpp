...
namespace rivet::ddl::generated {
	LightDef::LightDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		ColorTemperature = serialized->get_float(ColorTemperature_type_id, 6500.000000);
		Intensity = serialized->get_float(Intensity_type_id, 10.000000);
		AttenuationRadius = serialized->get_float(AttenuationRadius_type_id, 0.000000);
		VolumetricFogIntensity = serialized->get_float(VolumetricFogIntensity_type_id, 0.000000);
		Saturation = serialized->get_float(Saturation_type_id, 1.000000);
		...
		BulbPushForward = serialized->get_float(BulbPushForward_type_id, 0.000000);
		...
		CutoffRadius = serialized->get_float(CutoffRadius_type_id, 0.000000);
		CutOnDist = serialized->get_float(CutOnDist_type_id, 0.000000);
		ShadowCutOnDist = serialized->get_float(ShadowCutOnDist_type_id, 0.000000);
		FalloffDistX = serialized->get_float(FalloffDistX_type_id, 1.000000);
		FalloffDistPosX = serialized->get_float(FalloffDistPosX_type_id, 1.000000);
		FalloffDistY = serialized->get_float(FalloffDistY_type_id, 1.000000);
		FalloffDistPosY = serialized->get_float(FalloffDistPosY_type_id, 1.000000);
		FalloffDistZ = serialized->get_float(FalloffDistZ_type_id, 1.000000);
		FalloffDistPosZ = serialized->get_float(FalloffDistPosZ_type_id, 1.000000);
		FadeOutDist = serialized->get_float(FadeOutDist_type_id, 70.000000);
		NearFadeClipDist = serialized->get_float(NearFadeClipDist_type_id, 0.000000);
		NearFadeStartDist = serialized->get_float(NearFadeStartDist_type_id, 0.000000);
		ShadowFadeOutDist = serialized->get_float(ShadowFadeOutDist_type_id, 0.000000);
		SpecFadeOutDist = serialized->get_float(SpecFadeOutDist_type_id, 0.000000);
