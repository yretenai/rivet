...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED FinaleNefWeakspotDamagedStageDestroyedEvent : EventBase {
		constexpr static std::string_view type_name = "FinaleNefWeakspotDamagedStageDestroyedEvent";
		constexpr static rivet::rivet_type_id type_id = 0x92ff8a9a;
		...
		explicit FinaleNefWeakspotDamagedStageDestroyedEvent() = default;
		explicit FinaleNefWeakspotDamagedStageDestroyedEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<FinaleNefWeakspotDamagedStageDestroyedEvent>;
	};
} // namespace rivet::ddl::generated
