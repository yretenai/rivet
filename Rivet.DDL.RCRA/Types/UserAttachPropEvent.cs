...
public class UserAttachPropEvent : EventBase, IDDLObjectType<UserAttachPropEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0x639b548du);

	public UserAttachPropEvent(DDLObject ddl) : base(ddl) {
