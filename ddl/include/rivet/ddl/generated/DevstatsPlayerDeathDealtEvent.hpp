...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsPlayerDeathDealtEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsPlayerDeathDealtEvent";
		constexpr static rivet::rivet_type_id type_id = 0xbc3eea41;
		...
		explicit DevstatsPlayerDeathDealtEvent() = default;
		explicit DevstatsPlayerDeathDealtEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsPlayerDeathDealtEvent>;
	};
} // namespace rivet::ddl::generated
