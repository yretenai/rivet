...
namespace rivet::ddl::generated {
	AimAssistDistanceModifier::AimAssistDistanceModifier([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		FrictionDistanceNear = serialized->get_float(FrictionDistanceNear_type_id, 5.000000f);
		FrictionDistanceFar = serialized->get_float(FrictionDistanceFar_type_id, 15.000000f);
		FrictionMod = serialized->get_float(FrictionMod_type_id, 1.000000f);
		MagnetDistanceNear = serialized->get_float(MagnetDistanceNear_type_id, 5.000000f);
		MagnetDistanceFar = serialized->get_float(MagnetDistanceFar_type_id, 15.000000f);
		MagnetMod = serialized->get_float(MagnetMod_type_id, 1.000000f);
		CenterDistanceNear = serialized->get_float(CenterDistanceNear_type_id, 5.000000f);
		CenterDistanceFar = serialized->get_float(CenterDistanceFar_type_id, 15.000000f);
