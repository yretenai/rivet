...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ItemLoadoutListElement : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "ItemLoadoutListElement";
		constexpr static rivet::rivet_type_id type_id = 0x180f64cf;
		...
		constexpr static std::string_view ItemProgression_type_name = "ItemProgression";
		constexpr static rivet::rivet_type_id ItemProgression_type_id = 0x8e3fd75b;
		...
		constexpr static std::string_view EquipTarget_type_name = "EquipTarget";
		constexpr static rivet::rivet_type_id EquipTarget_type_id = 0xb7aa52a3;
