...
public class DialogTriggerDisabledPrius : DDLObjectType, IDDLObjectType<DialogTriggerDisabledPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x56fadd6bu);

	public DialogTriggerDisabledPrius(DDLObject ddl) : base(ddl) {
