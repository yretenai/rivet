...
public class HoverEffectChangedEvent : EventBase, IDDLObjectType<HoverEffectChangedEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0xb05dde83u);

	public HoverEffectChangedEvent(DDLObject ddl) : base(ddl) {
