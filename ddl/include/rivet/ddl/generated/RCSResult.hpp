...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED RCSResult : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "RCSResult";
		constexpr static rivet::rivet_type_id type_id = 0xaa8a3353;
		...
		explicit RCSResult() = default;
		explicit RCSResult([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<RCSResult>;
	};
} // namespace rivet::ddl::generated
