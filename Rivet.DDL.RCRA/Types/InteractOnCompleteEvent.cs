...
public class InteractOnCompleteEvent : EventBase, IDDLObjectType<InteractOnCompleteEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0xfb19aac0u);

	public InteractOnCompleteEvent(DDLObject ddl) : base(ddl) {
