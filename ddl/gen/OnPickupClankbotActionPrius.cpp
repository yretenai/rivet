...
#include <rivet/ddl/generated/OnPickupClankbotActionPrius.hpp>
...
namespace rivet::ddl::generated {
	...
	[[nodiscard]] auto
	OnPickupClankbotActionPrius::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	OnPickupClankbotActionPrius::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<OnPickupClankbotActionPrius> {
		if (incoming_type_id == OnPickupClankbotActionPrius::type_id) {
			return std::make_shared<OnPickupClankbotActionPrius>(serialized);
		}
