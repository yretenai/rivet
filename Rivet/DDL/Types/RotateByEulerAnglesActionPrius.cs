...
public class RotateByEulerAnglesActionPrius : DDLObjectType, IDDLObjectType<RotateByEulerAnglesActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xa032e2a8u);

	public RotateByEulerAnglesActionPrius(DDLObject ddl) : base(ddl) {
