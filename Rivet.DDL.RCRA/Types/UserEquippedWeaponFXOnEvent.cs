...
[DDLRegistration(0xabd1b078u)]
public class UserEquippedWeaponFXOnEvent : EventBase, IDDLObjectType<UserEquippedWeaponFXOnEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0xabd1b078u);

	public UserEquippedWeaponFXOnEvent(DDLObject ddl) : base(ddl) {
	...
	public new static UserEquippedWeaponFXOnEvent Create(DDLObject ddl) => new(ddl);
}
