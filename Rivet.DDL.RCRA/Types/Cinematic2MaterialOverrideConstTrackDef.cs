...
public class Cinematic2MaterialOverrideConstTrackDef : DDLObjectType, IDDLObjectType<Cinematic2MaterialOverrideConstTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x61195b4au);

	public Cinematic2MaterialOverrideConstTrackDef(DDLObject ddl) : base(ddl) {
