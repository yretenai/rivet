...
namespace rivet::ddl::generated {
	HeroGroovitronConfig::HeroGroovitronConfig([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		MoveMaxSpeed = serialized->get_float(MoveMaxSpeed_type_id, 4.000000f);
		MoveAccel = serialized->get_float(MoveAccel_type_id, 8.000000f);
		MoveDecel = serialized->get_float(MoveDecel_type_id, 1.000000f);
		JumpMinHeight = serialized->get_float(JumpMinHeight_type_id, 1.500000f);
		JumpMaxHeight = serialized->get_float(JumpMaxHeight_type_id, 2.500000f);
		JumpMaxHoldTime = serialized->get_float(JumpMaxHoldTime_type_id, 0.200000f);
		JumpTerminalVelocity = serialized->get_float(JumpTerminalVelocity_type_id, 50.000000f);
		JumpPeakTime = serialized->get_float(JumpPeakTime_type_id, 0.300000f); 
	}
