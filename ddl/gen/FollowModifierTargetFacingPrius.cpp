...
namespace rivet::ddl::generated {
	FollowModifierTargetFacingPrius::FollowModifierTargetFacingPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		TargetActorHandle = serialized->get_uint32(TargetActorHandle_type_id, 0u);
		TargetYaw = serialized->get_float(TargetYaw_type_id, 9999.000000f);
		TargetPitch = serialized->get_float(TargetPitch_type_id, 9999.000000f);
		TargetTolerance = serialized->get_float(TargetTolerance_type_id, 0.000000f);
		AccelOrGain = serialized->get_float(AccelOrGain_type_id, 30.000000f);
		DecelOrDamp = serialized->get_float(DecelOrDamp_type_id, 8.000000f);
		...
		LockBlendTime = serialized->get_float(LockBlendTime_type_id, 0.000000f);
		PeakAngle = serialized->get_float(PeakAngle_type_id, 3.141593f);
		BackDeadAngle = serialized->get_float(BackDeadAngle_type_id, 31.512678f);
