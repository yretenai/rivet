...
namespace rivet::ddl::generated {
	ItemPrius::ItemPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		ItemGuid = serialized->get_uint64(ItemGuid_type_id, 0ull);
		ItemConfigHash = serialized->get_uint64(ItemConfigHash_type_id, 0ull);
		ItemCount = serialized->get_uint32(ItemCount_type_id, 1u);
