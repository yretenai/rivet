...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED LevelArea : rivet::structures::rivet_ddl_base {
		...
		std::vector<std::shared_ptr<rivet::ddl::generated::RegionData>> Regions {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<LevelArea>;
	};
} // namespace rivet::ddl::generated
