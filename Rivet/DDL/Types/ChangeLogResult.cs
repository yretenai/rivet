...
public class ChangeLogResult : DDLObjectType, IDDLObjectType<ChangeLogResult> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xbea0c844u);

	public ChangeLogResult(DDLObject ddl) : base(ddl) {
		...
		ChangeType = ddl.GetEnum<ChangeType>(0x6b94ddc9u, ChangeTypeValues.Lookup);
