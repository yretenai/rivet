...
public class UIViewRTTVisibilityActionPrius : DDLObjectType, IDDLObjectType<UIViewRTTVisibilityActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xbbb90726u);

	public UIViewRTTVisibilityActionPrius(DDLObject ddl) : base(ddl) {
