...
public class Cinematic2AtmosphereModifierTrackDef : DDLObjectType, IDDLObjectType<Cinematic2AtmosphereModifierTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x8c9212bbu);

	public Cinematic2AtmosphereModifierTrackDef(DDLObject ddl) : base(ddl) {
