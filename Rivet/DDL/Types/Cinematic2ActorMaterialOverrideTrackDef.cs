...
public class Cinematic2ActorMaterialOverrideTrackDef : DDLObjectType, IDDLObjectType<Cinematic2ActorMaterialOverrideTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x81ad6717u);

	public Cinematic2ActorMaterialOverrideTrackDef(DDLObject ddl) : base(ddl) {
	...
	[DDLRegistration(0x81ad6717u, description: "Track will only run on the defined platform(s)")]
	public xb52df7e7 PlatformFilter { get; set; } = (xb52df7e7) 0x00000007;

	[DDLRegistration(0x81ad6717u, description: "A set of gameplay-defined values to determine if this track should be processed.")]
	public Cinematic2TrackTagsDef? Tags { get; set; } = default;

	[DDLRegistration(0x81ad6717u, description: "If set to true, actions on this track will not move when shots are reordered.")]
	...
	public static Cinematic2ActorMaterialOverrideTrackDef Create(DDLObject ddl) => new(ddl);
}
