...
[DDLRegistration(0xe2e70a92u)]
public class RCSSubmitOutput : DDLObjectType, IDDLObjectType<RCSSubmitOutput> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xe2e70a92u);

	public RCSSubmitOutput(DDLObject ddl) : base(ddl) {
