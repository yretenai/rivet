...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED HazardDamageAreaConfig : ConfigBase {
		constexpr static std::string_view type_name = "HazardDamageAreaConfig";
		constexpr static rivet::rivet_type_id type_id = 0x800030f0;

		constexpr static std::string_view HazardLifetime_type_name = "HazardLifetime";
		constexpr static rivet::rivet_type_id HazardLifetime_type_id = 0xe2a53270;
		constexpr static std::string_view InsideDPS_type_name = "InsideDPS";
		constexpr static rivet::rivet_type_id InsideDPS_type_id = 0xfc2e344a;
		constexpr static std::string_view DotDPS_type_name = "DotDPS";
		constexpr static rivet::rivet_type_id DotDPS_type_id = 0xdcaa0dd9;
		constexpr static std::string_view DotDuration_type_name = "DotDuration";
		constexpr static rivet::rivet_type_id DotDuration_type_id = 0x91fef556;
		...
		constexpr static std::string_view EffectOffTime_type_name = "EffectOffTime";
		constexpr static rivet::rivet_type_id EffectOffTime_type_id = 0xb29b36ab;
		constexpr static std::string_view DamageSendInterval_type_name = "DamageSendInterval";
		constexpr static rivet::rivet_type_id DamageSendInterval_type_id = 0xcf20fa13;
		...
		constexpr static std::string_view SweptSphereEndOffset_type_name = "SweptSphereEndOffset";
		constexpr static rivet::rivet_type_id SweptSphereEndOffset_type_id = 0xd7f5902c; 
