...
namespace rivet::ddl::generated {
	RandomBotSpawnData::RandomBotSpawnData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): ActorSpawnData(serialized) {
		...
		EncounterControllerActor = serialized->get_uint32(EncounterControllerActor_type_id, 0u);
		HomeArea = serialized->get_uint32(HomeArea_type_id, 0u);
		BotAssetId = serialized->get_uint64(BotAssetId_type_id, 0ull); 
	}
