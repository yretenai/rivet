...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ShotIcicleBombPrius : SimpleShotPrius {
		...
		std::shared_ptr<rivet::ddl::generated::ShotMotionIcicleBombPrius> ExplosionMotionData {};
		std::shared_ptr<rivet::ddl::generated::ShotDamageData> ExplosionDamage {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ShotIcicleBombPrius>;
	};
} // namespace rivet::ddl::generated
