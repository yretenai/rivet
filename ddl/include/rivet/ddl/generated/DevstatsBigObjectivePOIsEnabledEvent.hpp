...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsBigObjectivePOIsEnabledEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsBigObjectivePOIsEnabledEvent";
		constexpr static rivet::rivet_type_id type_id = 0x67755a65;
		...
		explicit DevstatsBigObjectivePOIsEnabledEvent() = default;
		explicit DevstatsBigObjectivePOIsEnabledEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsBigObjectivePOIsEnabledEvent>;
	};
} // namespace rivet::ddl::generated
