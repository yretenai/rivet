...
namespace rivet::ddl::generated {
	HoverShuffleData::HoverShuffleData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		HoverShuffleMinRange = serialized->get_float(HoverShuffleMinRange_type_id);
		HoverShuffleMaxRange = serialized->get_float(HoverShuffleMaxRange_type_id);
		HoverShuffleDistShortThreshold = serialized->get_float(HoverShuffleDistShortThreshold_type_id);
		HoverShuffleDistMediumThreshold = serialized->get_float(HoverShuffleDistMediumThreshold_type_id);
		HoverShuffleDesiredMoveSpeed = serialized->get_float(HoverShuffleDesiredMoveSpeed_type_id); 
	}
