...
namespace rivet::ddl::generated {
	FirepointCluePrius::FirepointCluePrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		CoverProvided = serialized->get_bitset<rivet::ddl::generated::xec8eef95>(CoverProvided_type_id, rivet::ddl::generated::xec8eef95_values, 32u);
		...
		SearchAreas = serialized->get_uint64(SearchAreas_type_id, 0ull); 
	}
