...
#include <rivet/ddl/generated/UI_MaterialNodeInputPortXYZW.hpp>

namespace rivet::ddl::generated {
	UI_MaterialNodeInputPortXYZW::UI_MaterialNodeInputPortXYZW([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		W = serialized->get_float(W_type_id, 0.000000f); 
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortXYZW::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	UI_MaterialNodeInputPortXYZW::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortXYZW> {
		if (incoming_type_id == UI_MaterialNodeInputPortXYZW::type_id) {
			return std::make_shared<UI_MaterialNodeInputPortXYZW>(serialized);
		}
