...
namespace rivet::ddl::generated {
	ShotKamehamehaPrius::ShotKamehamehaPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): BeamShotPrius(serialized) {
		...
		V5ExplosionDamageLOSType = serialized->get_enum<rivet::ddl::generated::DamageLOSTypes>(V5ExplosionDamageLOSType_type_id, rivet::ddl::generated::DamageLOSTypes_values, rivet::ddl::generated::DamageLOSTypes::LOS); 
	}
