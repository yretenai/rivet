...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED AimAssistCurveData : rivet::structures::rivet_ddl_base {
		...
		std::string_view AimAssistCurve {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<AimAssistCurveData>;
	};
} // namespace rivet::ddl::generated
