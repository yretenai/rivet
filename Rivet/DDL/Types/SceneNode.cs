...
[DDLRegistration(0x4d15bed8u)]
public class SceneNode : DDLObjectType, IDDLObjectType<SceneNode> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x4d15bed8u);

	public SceneNode(DDLObject ddl) : base(ddl) {
	...
	[DDLRegistration(0x4d15bed8u, "Transform")]
	...
	[DDLRegistration(0x4d15bed8u, description: "User settable sorting key")]
	public float SortValue { get; set; } = 0.00f;

	[DDLRegistration(0x4d15bed8u, "Type")]
	public AssetExtensions AssetType { get; set; } = AssetExtensions.Actor;

	[DDLRegistration(0x4d15bed8u, "Asset Path")]
	...
	[DDLRegistration(0x4d15bed8u, "Asset Overrides")]
	public string? AssetOverrides { get; set; } = default;

	[DDLRegistration(0x4d15bed8u, "Actor Overrides")]
	public string? ActorOverrides { get; set; } = default;

	public static SceneNode Create(DDLObject ddl) => new(ddl);
}
