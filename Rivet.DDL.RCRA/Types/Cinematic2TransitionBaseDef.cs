...
public class Cinematic2TransitionBaseDef : DDLObjectType, IDDLObjectType<Cinematic2TransitionBaseDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xf77c5fa0u);

	public Cinematic2TransitionBaseDef(DDLObject ddl) : base(ddl) {
