...
namespace rivet::ddl::generated {
	DebugGraphDrawSettings::DebugGraphDrawSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		ScrollSpeedVertical = serialized->get_float(ScrollSpeedVertical_type_id);
		ScrollSpeedHorizontal = serialized->get_float(ScrollSpeedHorizontal_type_id);
		NodeSpacingVertical = serialized->get_float(NodeSpacingVertical_type_id);
		NodeSpacingHorizontal = serialized->get_float(NodeSpacingHorizontal_type_id);
		VerticalSpacingMode = serialized->get_enum<rivet::ddl::generated::VerticalSpacingMode>(VerticalSpacingMode_type_id, rivet::ddl::generated::VerticalSpacingMode_values); 
	}
