...
namespace rivet::ddl::generated {
	PickupBobData::PickupBobData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		Amplitude = serialized->get_float(Amplitude_type_id, 0.000000f);
		Spin = serialized->get_float(Spin_type_id, 0.000000f);
		BumpHeightByAmp = serialized->get_bool(BumpHeightByAmp_type_id, false);
		AllowLOD = serialized->get_bool(AllowLOD_type_id, true);
