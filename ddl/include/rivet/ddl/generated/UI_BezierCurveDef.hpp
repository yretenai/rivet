...
namespace rivet::ddl::generated {
	struct UI_BezierCurveValue;
	struct BezierCurveDimensionDef; 

	struct RIVET_DDL_SHARED UI_BezierCurveDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_BezierCurveDef";
		constexpr static rivet::rivet_type_id type_id = 0x68b86cd4;
		...
		constexpr static std::string_view uiCurrentValue_type_name = "uiCurrentValue";
		constexpr static rivet::rivet_type_id uiCurrentValue_type_id = 0x84e98eff; 

		explicit UI_BezierCurveDef() = default;
		explicit UI_BezierCurveDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::UI_BezierCurveValue> uiCurrentValue {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_BezierCurveDef>;
	};
} // namespace rivet::ddl::generated
