...
public class OceanDef : DDLObjectType, IDDLObjectType<OceanDef> {
	...
	[DDLRegistration(0x9d7005a8u, "Foam Fade", "The amount of foam to fade out per frame (can be over unity).")]
	public float FoamFade { get; set; } = 0.40f;

	[DDLRegistration(0x778443f7u, "Foam Power", "The rate at which the foam lower values drop off.  Higher numbers cause faster dropoff.")]
