...
public class UBPActivity : DDLObjectType, IDDLObjectType<UBPActivity> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xb1133c08u);

	public UBPActivity(DDLObject ddl) : base(ddl) {
