...
namespace rivet::ddl::generated {
	TrainCarPrius::TrainCarPrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		MaxPositionHistoryPoints = serialized->get_uint32(MaxPositionHistoryPoints_type_id, 128);
		RearAxleOffset = serialized->get_float(RearAxleOffset_type_id, 5.000000);
		AdditionalTolerance = serialized->get_float(AdditionalTolerance_type_id, 0.000000); 
	}
