...
public class OnOpenEvent : EventBase, IDDLObjectType<OnOpenEvent> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0x901f349au);

	public OnOpenEvent(DDLObject ddl) : base(ddl) {
