...
namespace rivet::ddl::generated {
	PhysicsExperimentalSoftKickableConfig::PhysicsExperimentalSoftKickableConfig([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): ConfigBase(serialized) {
		MaxContactImpulseAtLowSpeed = serialized->get_float(MaxContactImpulseAtLowSpeed_type_id, 100.000000f);
		LowSpeed = serialized->get_float(LowSpeed_type_id, 0.000000f);
		MaxContactImpulseAtHighSpeed = serialized->get_float(MaxContactImpulseAtHighSpeed_type_id, 100.000000f);
		HighSpeed = serialized->get_float(HighSpeed_type_id, 100.000000f); 
	}
