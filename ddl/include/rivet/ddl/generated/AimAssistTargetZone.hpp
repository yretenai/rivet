...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED AimAssistTargetZone : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "AimAssistTargetZone";
		constexpr static rivet::rivet_type_id type_id = 0x348dd48e;

		constexpr static std::string_view AimAssistFactor_type_name = "AimAssistFactor";
		constexpr static rivet::rivet_type_id AimAssistFactor_type_id = 0x4bf6bff; 
