...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED EmergentVOManagerBotPrius : EmergentVOManagerGamePrius {
		constexpr const static std::string_view type_name = "EmergentVOManagerBotPrius";
		constexpr const static rivet::rivet_type_id type_id = 0x21698788;

		constexpr const static std::string_view LookGroupVoiceOverrideData_type_name = "LookGroupVoiceOverrideData";
		constexpr const static rivet::rivet_type_id LookGroupVoiceOverrideData_type_id = 0x177a05d0;
		constexpr const static std::string_view VoiceSwitches_type_name = "VoiceSwitches";
		constexpr const static rivet::rivet_type_id VoiceSwitches_type_id = 0x1879581e;
		...
		constexpr const static std::string_view OffScreenApproachingTaunt_type_name = "OffScreenApproachingTaunt";
		constexpr const static rivet::rivet_type_id OffScreenApproachingTaunt_type_id = 0xbbeeedae; 
