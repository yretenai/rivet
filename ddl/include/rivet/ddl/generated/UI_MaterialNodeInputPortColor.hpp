...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortColor : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortColor";
		constexpr static rivet::rivet_type_id type_id = 0x31b36611;
		...
		explicit UI_MaterialNodeInputPortColor() = default;
		explicit UI_MaterialNodeInputPortColor([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortColor>;
	};
} // namespace rivet::ddl::generated
