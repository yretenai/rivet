...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED UI_MaterialNodeInputPortBase : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "UI_MaterialNodeInputPortBase";
		constexpr static rivet::rivet_type_id type_id = 0x42455333;
		...
		explicit UI_MaterialNodeInputPortBase() = default;
		explicit UI_MaterialNodeInputPortBase([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<UI_MaterialNodeInputPortBase>;
	};
} // namespace rivet::ddl::generated
