...
namespace rivet::ddl::generated {
	SoundPropagation2PortalParamsDef::SoundPropagation2PortalParamsDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		AttenuationFadeScalar = serialized->get_float(AttenuationFadeScalar_type_id, 2.000000f);
		MaxFilteredAttenuationAngle = serialized->get_float(MaxFilteredAttenuationAngle_type_id, 80.000000f);
		MaxFullAttenuationAngle = serialized->get_float(MaxFullAttenuationAngle_type_id, 170.000000f); 
	}
