...
public class VisualEffectGraphNode : DDLObjectType, IDDLObjectType<VisualEffectGraphNode> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x3779cabeu);

	public VisualEffectGraphNode(DDLObject ddl) : base(ddl) {
