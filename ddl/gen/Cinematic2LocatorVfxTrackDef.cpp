...
namespace rivet::ddl::generated {
	Cinematic2LocatorVfxTrackDef::Cinematic2LocatorVfxTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
	...
	[[nodiscard]] auto
	Cinematic2LocatorVfxTrackDef::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	Cinematic2LocatorVfxTrackDef::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2LocatorVfxTrackDef> {
		if (incoming_type_id == Cinematic2LocatorVfxTrackDef::type_id) {
			return std::make_shared<Cinematic2LocatorVfxTrackDef>(serialized);
		}
