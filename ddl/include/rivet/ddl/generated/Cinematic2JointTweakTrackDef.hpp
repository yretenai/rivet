...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2JointTweakTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2JointTweakTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xf88fca82;
		...
		explicit Cinematic2JointTweakTrackDef() = default;
		explicit Cinematic2JointTweakTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2JointTweakTrackDef>;
	};
} // namespace rivet::ddl::generated
