...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED AimAssistCentering : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "AimAssistCentering";
		constexpr static rivet::rivet_type_id type_id = 0xe95b5831;
		...
		constexpr static std::string_view MinBoxValue_type_name = "MinBoxValue";
		constexpr static rivet::rivet_type_id MinBoxValue_type_id = 0x2febb899;
		constexpr static std::string_view MaxBoxValue_type_name = "MaxBoxValue";
		constexpr static rivet::rivet_type_id MaxBoxValue_type_id = 0xe3e6c396; 
