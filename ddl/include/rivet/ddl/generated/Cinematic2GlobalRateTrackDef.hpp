...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED Cinematic2GlobalRateTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2GlobalRateTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0xc8bfbcfa;
		...
		constexpr static std::string_view AffectWorldClock_type_name = "AffectWorldClock";
		constexpr static rivet::rivet_type_id AffectWorldClock_type_id = 0x7c264736; 

		explicit Cinematic2GlobalRateTrackDef() = default;
		explicit Cinematic2GlobalRateTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		bool AffectWorldClock {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2GlobalRateTrackDef>;
	};
} // namespace rivet::ddl::generated
