...
namespace rivet::ddl::generated {
	ActorLinkExample::ActorLinkExample([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		AnyActor = serialized->get_uint64(AnyActor_type_id, 0ull);
		AnyModelOrVolumeActor = serialized->get_uint64(AnyModelOrVolumeActor_type_id, 0ull);
		AnyKindOfModel = serialized->get_uint64(AnyKindOfModel_type_id, 0ull);
		AnyKindOfSceneNode = serialized->get_uint64(AnyKindOfSceneNode_type_id, 0ull); 
	}
