...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsHighContrastBackgroundEnabledEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsHighContrastBackgroundEnabledEvent";
		constexpr static rivet::rivet_type_id type_id = 0x8fbfd6b3;
		...
		explicit DevstatsHighContrastBackgroundEnabledEvent() = default;
		explicit DevstatsHighContrastBackgroundEnabledEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsHighContrastBackgroundEnabledEvent>;
	};
} // namespace rivet::ddl::generated
