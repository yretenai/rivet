...
public class DDLQuaternion : DDLObjectType, IDDLObjectType<DDLQuaternion> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0xf64f4a67u);

	public DDLQuaternion(DDLObject ddl) : base(ddl) {
