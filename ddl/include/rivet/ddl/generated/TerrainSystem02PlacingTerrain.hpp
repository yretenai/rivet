...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED TerrainSystem02PlacingTerrain : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "TerrainSystem02PlacingTerrain";
		constexpr static rivet::rivet_type_id type_id = 0x9212dca2;
		...
		explicit TerrainSystem02PlacingTerrain() = default;
		explicit TerrainSystem02PlacingTerrain([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TerrainSystem02PlacingTerrain>;
	};
} // namespace rivet::ddl::generated
