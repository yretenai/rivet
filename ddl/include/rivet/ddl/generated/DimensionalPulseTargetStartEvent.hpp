...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DimensionalPulseTargetStartEvent : EventBase {
		constexpr static std::string_view type_name = "DimensionalPulseTargetStartEvent";
		constexpr static rivet::rivet_type_id type_id = 0x851a3563;

		constexpr static std::string_view TimeToHit_type_name = "TimeToHit";
		constexpr static rivet::rivet_type_id TimeToHit_type_id = 0x874f26ca;
		...
		explicit DimensionalPulseTargetStartEvent() = default;
		explicit DimensionalPulseTargetStartEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DimensionalPulseTargetStartEvent>;
	};
} // namespace rivet::ddl::generated
