...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED BotComboMoveFinaleProtonSeeker : BotComboMoveBase {
		constexpr const static std::string_view type_name = "BotComboMoveFinaleProtonSeeker";
		constexpr const static rivet::rivet_type_id type_id = 0x12896da3;

		constexpr const static std::string_view SpawnedShotConfigTargeted_type_name = "SpawnedShotConfigTargeted";
		constexpr const static rivet::rivet_type_id SpawnedShotConfigTargeted_type_id = 0x332351ea;
		constexpr const static std::string_view SpawnedShotConfigScatter_type_name = "SpawnedShotConfigScatter";
		constexpr const static rivet::rivet_type_id SpawnedShotConfigScatter_type_id = 0x21ea3f;
		constexpr const static std::string_view SpawnedShotConfigExplosive_type_name = "SpawnedShotConfigExplosive";
		constexpr const static rivet::rivet_type_id SpawnedShotConfigExplosive_type_id = 0xfeaa8997;
		...
		constexpr const static std::string_view WeaponActorId_type_name = "WeaponActorId";
		constexpr const static rivet::rivet_type_id WeaponActorId_type_id = 0x59c9ba1f;
		...
		constexpr const static std::string_view WeaponActorEmitLocator_type_name = "WeaponActorEmitLocator";
		constexpr const static rivet::rivet_type_id WeaponActorEmitLocator_type_id = 0x40094dbd;
		...
		constexpr const static std::string_view GoThruEachFiringPattern_type_name = "GoThruEachFiringPattern";
		constexpr const static rivet::rivet_type_id GoThruEachFiringPattern_type_id = 0xd081eca5;
