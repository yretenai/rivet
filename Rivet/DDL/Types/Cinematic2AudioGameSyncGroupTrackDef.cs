...
public class Cinematic2AudioGameSyncGroupTrackDef : DDLObjectType, IDDLObjectType<Cinematic2AudioGameSyncGroupTrackDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x9007d75eu);

	public Cinematic2AudioGameSyncGroupTrackDef(DDLObject ddl) : base(ddl) {
