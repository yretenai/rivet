...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED ShotTunnelerPrius : ExplosiveBulletPrius {
		...
		bool IsPuppy {};
		std::shared_ptr<rivet::ddl::generated::TunnelerBombPrius> BombData {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<ShotTunnelerPrius>;
	};
} // namespace rivet::ddl::generated
