...
namespace rivet::ddl::generated {
	AnimVisDumpSequenceDef::AnimVisDumpSequenceDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		FrameCount = serialized->get_uint32(FrameCount_type_id);
		TimeStart = serialized->get_float(TimeStart_type_id);
		TimeEnd = serialized->get_float(TimeEnd_type_id);
		SampleRate = serialized->get_float(SampleRate_type_id);
