...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED LaserShotTypeAnimEventDriven : BotComboLaserShotType {
		constexpr static std::string_view type_name = "LaserShotTypeAnimEventDriven";
		constexpr static rivet::rivet_type_id type_id = 0x6ad13650;

		constexpr static std::string_view AllowUseWhileMoving_type_name = "AllowUseWhileMoving";
		constexpr static rivet::rivet_type_id AllowUseWhileMoving_type_id = 0x66a41a89;
		constexpr static std::string_view StrafeShootPartialAnim_type_name = "StrafeShootPartialAnim";
		constexpr static rivet::rivet_type_id StrafeShootPartialAnim_type_id = 0xd312963d;
		constexpr static std::string_view ScaleTellTime_type_name = "ScaleTellTime";
		constexpr static rivet::rivet_type_id ScaleTellTime_type_id = 0xe17e403c;
		constexpr static std::string_view ScaleShootTime_type_name = "ScaleShootTime";
		constexpr static rivet::rivet_type_id ScaleShootTime_type_id = 0x561eaa97;
		constexpr static std::string_view ScaleRecoveryTime_type_name = "ScaleRecoveryTime";
		constexpr static rivet::rivet_type_id ScaleRecoveryTime_type_id = 0x4eeca312;
		constexpr static std::string_view TweakHeadingTowardsTarget_type_name = "TweakHeadingTowardsTarget";
		constexpr static rivet::rivet_type_id TweakHeadingTowardsTarget_type_id = 0xa28d0c60;
		constexpr static std::string_view TweakHeadingTime_type_name = "TweakHeadingTime";
		constexpr static rivet::rivet_type_id TweakHeadingTime_type_id = 0x14be983a;
		...
		constexpr static std::string_view LimitRange_type_name = "LimitRange";
		constexpr static rivet::rivet_type_id LimitRange_type_id = 0x52b09495;
