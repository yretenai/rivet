...
public class ModelGeneratorItem : DDLObjectType, IDDLObjectType<ModelGeneratorItem> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x273c3ddfu);

	public ModelGeneratorItem(DDLObject ddl) : base(ddl) {
		MergeMethod = ddl.GetEnum<MergeMethodSelect>(0x7f174b7au, MergeMethodSelectValues.Lookup);
		ModelSource = ddl.GetEnum<ModelGeneratorSelect>(0x6181e7f5u, ModelGeneratorSelectValues.Lookup);
