...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsBigObjectivePOIsDisabledEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsBigObjectivePOIsDisabledEvent";
		constexpr static rivet::rivet_type_id type_id = 0x7b2b9128;
		...
		explicit DevstatsBigObjectivePOIsDisabledEvent() = default;
		explicit DevstatsBigObjectivePOIsDisabledEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsBigObjectivePOIsDisabledEvent>;
	};
} // namespace rivet::ddl::generated
