...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED DevstatsAccessibilityUseShortcutEvent : EventBase {
		constexpr static std::string_view type_name = "DevstatsAccessibilityUseShortcutEvent";
		constexpr static rivet::rivet_type_id type_id = 0xd19ee71d;
		...
		explicit DevstatsAccessibilityUseShortcutEvent() = default;
		explicit DevstatsAccessibilityUseShortcutEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<DevstatsAccessibilityUseShortcutEvent>;
	};
} // namespace rivet::ddl::generated
