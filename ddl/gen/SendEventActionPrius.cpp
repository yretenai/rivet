...
#include <rivet/ddl/generated/SendEventActionPrius.hpp>
...
namespace rivet::ddl::generated {
	...
	[[nodiscard]] auto
	SendEventActionPrius::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	SendEventActionPrius::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<SendEventActionPrius> {
		if (incoming_type_id == SendEventActionPrius::type_id) {
			return std::make_shared<SendEventActionPrius>(serialized);
		}
