...
namespace rivet::ddl::generated {
	AssetManagerSettings::AssetManagerSettings([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		AssertOnLoadError = serialized->get_bool(AssertOnLoadError_type_id);
		AssertOnMaxCount = serialized->get_bool(AssertOnMaxCount_type_id);
		VisualEffectSingleFrameMax = serialized->get_uint32(VisualEffectSingleFrameMax_type_id);
		TextureStreamBufferSize = serialized->get_uint32(TextureStreamBufferSize_type_id);
		TextureLowMipsMaxSize = serialized->get_uint32(TextureLowMipsMaxSize_type_id);
		ZoneGameplayDataCallbackMax = serialized->get_int32(ZoneGameplayDataCallbackMax_type_id);
		ZoneManagerCallbackMax = serialized->get_int32(ZoneManagerCallbackMax_type_id);
		ZoneManagerCombinedScriptActionTypeMax = serialized->get_int32(ZoneManagerCombinedScriptActionTypeMax_type_id);
		ZoneLightBinMax = serialized->get_uint32(ZoneLightBinMax_type_id);
		LightGridUnpackBufferSize = serialized->get_uint32(LightGridUnpackBufferSize_type_id);
		MaxEnvProbeEntries = serialized->get_uint32(MaxEnvProbeEntries_type_id);
		AssetLoaderTempAllocSize = serialized->get_uint32(AssetLoaderTempAllocSize_type_id);
		MaxVertexShaders = serialized->get_uint32(MaxVertexShaders_type_id);
		MaxHullShaders = serialized->get_uint32(MaxHullShaders_type_id);
		MaxDomainShaders = serialized->get_uint32(MaxDomainShaders_type_id);
		MaxPixelShaders = serialized->get_uint32(MaxPixelShaders_type_id);
		AudioLanguage = serialized->get_enum<rivet::ddl::generated::x572515d>(AudioLanguage_type_id, rivet::ddl::generated::x572515d_values);
		TextLanguage = serialized->get_enum<rivet::ddl::generated::x572515d>(TextLanguage_type_id, rivet::ddl::generated::x572515d_values);
		DebugLocalization = serialized->get_bool(DebugLocalization_type_id);
		VerboseDiagnostics = serialized->get_bool(VerboseDiagnostics_type_id);
		WarnOnZoneLooseLoads = serialized->get_bool(WarnOnZoneLooseLoads_type_id);
		LoadHistoryDetailLevel = serialized->get_enum<rivet::ddl::generated::LoadHistoryDetailLevel>(LoadHistoryDetailLevel_type_id, rivet::ddl::generated::LoadHistoryDetailLevel_values);
		DisplayLooseLoadDetail = serialized->get_bool(DisplayLooseLoadDetail_type_id);
		DisableDelayedStreaming = serialized->get_bool(DisableDelayedStreaming_type_id);
		EnableZoneReloads = serialized->get_bool(EnableZoneReloads_type_id);
