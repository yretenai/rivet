...
public class SelfieDoppelgangerSpawnData : ActorSpawnData, IDDLObjectType<SelfieDoppelgangerSpawnData> {
	public new static RivetTypeId TypeId { get; } = new RivetTypeId(0x4aea3903u);

	public SelfieDoppelgangerSpawnData(DDLObject ddl) : base(ddl) {
