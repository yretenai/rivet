...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED HeroLevelUpBeginEvent : EventBase {
		constexpr static std::string_view type_name = "HeroLevelUpBeginEvent";
		constexpr static rivet::rivet_type_id type_id = 0xa89b4fa7;
		...
		explicit HeroLevelUpBeginEvent() = default;
		explicit HeroLevelUpBeginEvent([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<HeroLevelUpBeginEvent>;
	};
} // namespace rivet::ddl::generated
