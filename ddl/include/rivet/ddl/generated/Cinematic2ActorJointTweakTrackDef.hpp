...
namespace rivet::ddl::generated {
	struct Cinematic2TranslationCurveTrackDef;
	struct Cinematic2ScaleCurveTrackDef;
	struct Cinematic2RotationCurveTrackDef;
	struct Cinematic2TrackTagsDef; 

	struct RIVET_DDL_SHARED Cinematic2ActorJointTweakTrackDef : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "Cinematic2ActorJointTweakTrackDef";
		constexpr static rivet::rivet_type_id type_id = 0x7f9ccda4;
		...
		explicit Cinematic2ActorJointTweakTrackDef() = default;
		explicit Cinematic2ActorJointTweakTrackDef([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		std::shared_ptr<rivet::ddl::generated::Cinematic2TranslationCurveTrackDef> Translation {}; 

		[[nodiscard]] auto
		get_type_name() const noexcept -> std::string_view override;

		[[nodiscard]] static auto
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<Cinematic2ActorJointTweakTrackDef>;
	};
} // namespace rivet::ddl::generated
