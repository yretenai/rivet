...
namespace rivet::ddl::generated {
	FreezeShatterData::FreezeShatterData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		DamageRange = serialized->get_float(DamageRange_type_id);
	...
	auto
	FreezeShatterData::get_type_id() const noexcept -> rivet::rivet_type_id {
		return type_id;
	}

	[[nodiscard]] auto
	FreezeShatterData::get_type_name() const noexcept -> std::string_view {
		return type_name;
	}

	[[nodiscard]] auto
	FreezeShatterData::from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<FreezeShatterData> {
		if (incoming_type_id == FreezeShatterData::type_id) {
			return std::make_shared<FreezeShatterData>(serialized);
		}
