...
namespace rivet::ddl::generated {
	WeaponMeleePrius::WeaponMeleePrius([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): WeaponGamePrius(serialized) {
		SnapRangeEnemy = serialized->get_float(SnapRangeEnemy_type_id, 7.000000f);
		SnapRangeBreak = serialized->get_float(SnapRangeBreak_type_id, 6.000000f);
		...
		DefaultEmissiveIDValue = serialized->get_float(DefaultEmissiveIDValue_type_id, 1.000000f);
		UpgradeEmissiveIDValue = serialized->get_float(UpgradeEmissiveIDValue_type_id, 2.000000f); 
	}
