...
namespace rivet::ddl::generated {
	struct RIVET_DDL_SHARED TerrainSystem03EditingTerrain0221Flatten : rivet::structures::rivet_ddl_base {
		constexpr static std::string_view type_name = "TerrainSystem03EditingTerrain0221Flatten";
		constexpr static rivet::rivet_type_id type_id = 0x85fb26b;
		...
		explicit TerrainSystem03EditingTerrain0221Flatten() = default;
		explicit TerrainSystem03EditingTerrain0221Flatten([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized);
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<TerrainSystem03EditingTerrain0221Flatten>;
	};
} // namespace rivet::ddl::generated
