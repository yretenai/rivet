...
namespace rivet::ddl::generated {
	AssetProfileData::AssetProfileData([[maybe_unused]] const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized): rivet::structures::rivet_ddl_base(serialized) {
		...
		FileSize = serialized->get_uint32(FileSize_type_id, 0u);
		...
		RuntimeZoneTotalModelInstCount = serialized->get_uint32(RuntimeZoneTotalModelInstCount_type_id, 0u);
		RuntimeZoneDelayModelInstCount = serialized->get_uint32(RuntimeZoneDelayModelInstCount_type_id, 0u);
		...
		SoundSize = serialized->get_uint32(SoundSize_type_id, 0u);
		IndexCount = serialized->get_uint32(IndexCount_type_id, 0u);
		SkinBatchCount = serialized->get_uint32(SkinBatchCount_type_id, 0u);
		MorphBatchCount = serialized->get_uint32(MorphBatchCount_type_id, 0u);
		VertexCount = serialized->get_uint32(VertexCount_type_id, 0u);
		PhysicsAVMaterialsCount = serialized->get_uint32(PhysicsAVMaterialsCount_type_id, 0u);
		ClothJointCount = serialized->get_uint32(ClothJointCount_type_id, 0u);
		LocatorCount = serialized->get_uint32(LocatorCount_type_id, 0u);
		JointCount = serialized->get_uint32(JointCount_type_id, 0u);
		ResidentTextureSize = serialized->get_uint32(ResidentTextureSize_type_id, 0u);
