...
public class ChangeOpenCurveFollowModeActionPrius : DDLObjectType, IDDLObjectType<ChangeOpenCurveFollowModeActionPrius> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x3805accbu);

	public ChangeOpenCurveFollowModeActionPrius(DDLObject ddl) : base(ddl) {
