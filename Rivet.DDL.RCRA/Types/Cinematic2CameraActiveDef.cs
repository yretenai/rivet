...
[DDLRegistration(0x57f3cbedu)]
public class Cinematic2CameraActiveDef : DDLObjectType, IDDLObjectType<Cinematic2CameraActiveDef> {
	public static RivetTypeId TypeId { get; } = new RivetTypeId(0x57f3cbedu);

	public Cinematic2CameraActiveDef(DDLObject ddl) : base(ddl) {
	...
	public static Cinematic2CameraActiveDef Create(DDLObject ddl) => new(ddl);
}
