...
namespace rivet::ddl::generated {
	...
	struct RIVET_DDL_SHARED AssetSwapPlatSpec : ConfigBase {
		...
		std::vector<std::shared_ptr<rivet::ddl::generated::ZoneList>> ZoneLists {}; 
		...
		from_substruct(rivet_type_id incoming_type_id, const std::shared_ptr<const rivet::structures::rivet_serialized_object> &serialized) -> std::shared_ptr<AssetSwapPlatSpec>;
	};
} // namespace rivet::ddl::generated
